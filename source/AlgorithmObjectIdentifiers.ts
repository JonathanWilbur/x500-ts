...
export const csor: ID = new asn1.ObjectIdentifier([
    /* csor */ 3,
], usgov);
...
export const _decode_DSS_Parms = function (el: asn1.ASN1Element): DSS_Parms {
    ...
    if (sequence.length < 3) {
        throw new asn1.ASN1ConstructionError("DSS-Parms contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "p";
    sequence[1].name = "q";
...
export const _encode_DSS_Parms = function (value: DSS_Parms, elGetter: __utils.ASN1Encoder<DSS_Parms>): asn1.ASN1Element {
...
export const _encode_DomainParameters = function (value: DomainParameters, elGetter: __utils.ASN1Encoder<DomainParameters>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ...
            __utils._encodeInteger(value.g, __utils.BER),
            __utils._encodeInteger(value.q, __utils.BER),
            (value.j ? __utils._encodeInteger(value.j, __utils.BER) : undefined),
            (value.validationParms ? _encode_ValidationParms(value.validationParms, __utils.BER) : undefined)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
