...
export const _decode_SignedAttributes = __utils._decodeSetOf<Attribute>(
    () => _decode_Attribute
);
export const _encode_SignedAttributes = __utils._encodeSetOf<Attribute>(
    () => _encode_Attribute,
    __utils.BER
);
...
export const _encode_WrappedPDUInfo = function (
...
export const _encode_SenderStaticInfo = function (
...
export const _decode_SenderDhPublicKey = function (
    ...
    // TODO: Validate values.
    return new SenderDhPublicKey(algorithm, publicKey, sequence.slice(2));
};
export const _encode_SenderDhPublicKey = function (
...
export type SenderDhInfo =
    ...
    | asn1.ASN1Element;
export const _decode_SenderDhInfo = __utils._decode_extensible_choice<
    SenderDhInfo
>({
    "CONTEXT 0": [
        "senderStaticInfo",
...
export const _encode_KeyAgreement_keyEncryptionAlgorithm = function (
...
export const _encode_KeyAgreement = function (
    value: KeyAgreement,
...
export const _decode_EncryptedPduInfo_pduEncryptionAlgorithm = function (
    ...
    // TODO: Validate values.
    return new EncryptedPduInfo_pduEncryptionAlgorithm(algorithm, parameter);
};
export const _encode_EncryptedPduInfo_pduEncryptionAlgorithm = function (
...
export const _encode_EncryptedPduInfo = function (
...
export const _decode_EncryptedInfo = function (
    ...
    // TODO: Validate values.
    return new EncryptedInfo(keyAgreement, encryptedPduInfo, sequence.slice(2));
};
export const _encode_EncryptedInfo = function (
    value: EncryptedInfo,
...
export type TBSPDU_wrapper_conf =
    ...
    | asn1.ASN1Element;
export const _decode_TBSPDU_wrapper_conf = __utils._decode_extensible_choice<
    TBSPDU_wrapper_conf
>({
    "CONTEXT 2": [
        "clear",
        __utils._decode_explicit<WrappedPDUInfo>(() => _decode_WrappedPDUInfo),
    ],
    "CONTEXT 3": [
        "protected_",
        __utils._decode_explicit<EncryptedInfo>(() => _decode_EncryptedInfo),
    ],
});
export const _encode_TBSPDU_wrapper_conf = __utils._encode_choice<
    TBSPDU_wrapper_conf
>(
    {
...
export const _decode_TBSPDU_wrapper = function (
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        certPath: (_el: asn1.ASN1Element): void => {
            certPath = __utils._decode_explicit<PkiPath>(() => _decode_PkiPath)(
                _el
            );
        },
...
export const _encode_TBSPDU_wrapper = function (
...
export const _decode_PDU_wrapper = _get_decoder_for_SIGNED<TBSPDU_wrapper>(
    _decode_TBSPDU_wrapper
);
export const _encode_PDU_wrapper = _get_encoder_for_SIGNED<TBSPDU_wrapper>(
