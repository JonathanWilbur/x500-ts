...
export const _decode_DisplayText = __utils._decode_inextensible_choice<DisplayText>({
...
export const _encode_NoticeReference = function (value: NoticeReference, elGetter: __utils.ASN1Encoder<NoticeReference>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            _encode_DisplayText(value.organization, __utils.BER),
            __utils._encodeSequenceOf<asn1.INTEGER>(() => __utils._encodeInteger, __utils.BER)(value.noticeNumbers, __utils.BER)
        ],
...
export const _encode_UserNotice = function (value: UserNotice, elGetter: __utils.ASN1Encoder<UserNotice>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            (value.noticeRef ? _encode_NoticeReference(value.noticeRef, __utils.BER) : undefined),
            (value.explicitText ? _encode_DisplayText(value.explicitText, __utils.BER) : undefined)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _encode_AccessDescription = function (value: AccessDescription, elGetter: __utils.ASN1Encoder<AccessDescription>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            __utils._encodeObjectIdentifier(value.accessMethod, __utils.BER),
...
export const _decode_AuthorityInfoAccessSyntax = __utils._decodeSequenceOf<AccessDescription>(() => _decode_AccessDescription);
export const _encode_AuthorityInfoAccessSyntax = __utils._encodeSequenceOf<AccessDescription>(() => _encode_AccessDescription, __utils.BER);


// TODO: ObjectAssignment: subjectInfoAccess

export type SubjectInfoAccessSyntax = AccessDescription[]; // SequenceOfType
export const _decode_SubjectInfoAccessSyntax = __utils._decodeSequenceOf<AccessDescription>(() => _decode_AccessDescription);
export const _encode_SubjectInfoAccessSyntax = __utils._encodeSequenceOf<AccessDescription>(() => _encode_AccessDescription, __utils.BER);
...
export const _decode_CountryName = __utils._decode_explicit<CountryName>(() => __utils._decode_inextensible_choice<CountryName>({
    "UNIVERSAL 18": [ "x121_dcc_code", __utils._decodeNumericString ],
    "UNIVERSAL 19": [ "iso_3166_alpha2_code", __utils._decodePrintableString ]
}));
export const _encode_CountryName = __utils._encode_explicit(asn1.ASN1TagClass.application, 1, () => __utils._encode_choice<CountryName>({
    "x121_dcc_code": __utils._encodeNumericString,
    "iso_3166_alpha2_code": __utils._encodePrintableString,
}, __utils.BER), __utils.BER);


export type AdministrationDomainName =
    { numeric: asn1.NumericString }
    | { printable: asn1.PrintableString };
export const _decode_AdministrationDomainName = __utils._decode_explicit<AdministrationDomainName>(() => __utils._decode_inextensible_choice<AdministrationDomainName>({
    "UNIVERSAL 18": [ "numeric", __utils._decodeNumericString ],
    "UNIVERSAL 19": [ "printable", __utils._decodePrintableString ]
}));
export const _encode_AdministrationDomainName = __utils._encode_explicit(asn1.ASN1TagClass.application, 2, () => __utils._encode_choice<AdministrationDomainName>({
...
export type PrivateDomainName =
    { numeric: asn1.NumericString }
    | { printable: asn1.PrintableString };
export const _decode_PrivateDomainName = __utils._decode_inextensible_choice<PrivateDomainName>({
    "UNIVERSAL 18": [ "numeric", __utils._decodeNumericString ],
    "UNIVERSAL 19": [ "printable", __utils._decodePrintableString ]
});
export const _encode_PrivateDomainName = __utils._encode_choice<PrivateDomainName>({
    "numeric": __utils._encodeNumericString,
    "printable": __utils._encodePrintableString,
}, __utils.BER);
...
export const _decode_PersonalName = function (el: asn1.ASN1Element): PersonalName {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "surname": (_el: asn1.ASN1Element): void => { surname = __utils._decode_explicit<asn1.PrintableString>(() => __utils._decodePrintableString)(_el); },
        "given-name": (_el: asn1.ASN1Element): void => { given_name = __utils._decode_explicit<asn1.PrintableString>(() => __utils._decodePrintableString)(_el); },
        "initials": (_el: asn1.ASN1Element): void => { initials = __utils._decode_explicit<asn1.PrintableString>(() => __utils._decodePrintableString)(_el); },
        "generation-qualifier": (_el: asn1.ASN1Element): void => { generation_qualifier = __utils._decode_explicit<asn1.PrintableString>(() => __utils._decodePrintableString)(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
...
export const _encode_PersonalName = function (value: PersonalName, elGetter: __utils.ASN1Encoder<PersonalName>): asn1.ASN1Element {
    return __utils._encodeSet(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => __utils._encodePrintableString, __utils.BER)(value.surname, __utils.BER),
            (value.given_name ? __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => __utils._encodePrintableString, __utils.BER)(value.given_name, __utils.BER) : undefined),
            (value.initials ? __utils._encode_explicit(asn1.ASN1TagClass.context, 2, () => __utils._encodePrintableString, __utils.BER)(value.initials, __utils.BER) : undefined),
            (value.generation_qualifier ? __utils._encode_explicit(asn1.ASN1TagClass.context, 3, () => __utils._encodePrintableString, __utils.BER)(value.generation_qualifier, __utils.BER) : undefined)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_OrganizationalUnitNames = __utils._decodeSequenceOf<OrganizationalUnitName>(() => _decode_OrganizationalUnitName);
export const _encode_OrganizationalUnitNames = __utils._encodeSequenceOf<OrganizationalUnitName>(() => _encode_OrganizationalUnitName, __utils.BER);


export class BuiltInStandardAttributes {
    constructor (
        readonly country_name: CountryName | undefined,
        readonly administration_domain_name: AdministrationDomainName | undefined,
...
const _root_component_type_list_1_spec_for_BuiltInStandardAttributes: __utils.ComponentSpec[] = [
    ...
    new __utils.ComponentSpec("terminal-identifier", true, __utils.hasTag(asn1.ASN1TagClass.context, 1), undefined, undefined),
    new __utils.ComponentSpec("private-domain-name", true, __utils.hasTag(asn1.ASN1TagClass.context, 2), undefined, undefined),
    new __utils.ComponentSpec("organization-name", true, __utils.hasTag(asn1.ASN1TagClass.context, 3), undefined, undefined),
    new __utils.ComponentSpec("numeric-user-identifier", true, __utils.hasTag(asn1.ASN1TagClass.context, 4), undefined, undefined),
...
export const _decode_BuiltInStandardAttributes = function (el: asn1.ASN1Element): BuiltInStandardAttributes {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "country-name": (_el: asn1.ASN1Element): void => { country_name = _decode_CountryName(_el); },
        "administration-domain-name": (_el: asn1.ASN1Element): void => { administration_domain_name = _decode_AdministrationDomainName(_el); },
        "network-address": (_el: asn1.ASN1Element): void => { network_address = __utils._decode_explicit<NetworkAddress>(() => _decode_NetworkAddress)(_el); },
        "terminal-identifier": (_el: asn1.ASN1Element): void => { terminal_identifier = __utils._decode_explicit<TerminalIdentifier>(() => _decode_TerminalIdentifier)(_el); },
        "private-domain-name": (_el: asn1.ASN1Element): void => { private_domain_name = __utils._decode_explicit<PrivateDomainName>(() => _decode_PrivateDomainName)(_el); },
        "organization-name": (_el: asn1.ASN1Element): void => { organization_name = __utils._decode_explicit<OrganizationName>(() => _decode_OrganizationName)(_el); },
        "numeric-user-identifier": (_el: asn1.ASN1Element): void => { numeric_user_identifier = __utils._decode_explicit<NumericUserIdentifier>(() => _decode_NumericUserIdentifier)(_el); },
        "personal-name": (_el: asn1.ASN1Element): void => { personal_name = __utils._decode_explicit<PersonalName>(() => _decode_PersonalName)(_el); },
        "organizational-unit-names": (_el: asn1.ASN1Element): void => { organizational_unit_names = __utils._decode_explicit<OrganizationalUnitNames>(() => _decode_OrganizationalUnitNames)(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_BuiltInStandardAttributes = function (value: BuiltInStandardAttributes, elGetter: __utils.ASN1Encoder<BuiltInStandardAttributes>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            (value.country_name ? _encode_CountryName(value.country_name, __utils.BER) : undefined),
            (value.administration_domain_name ? _encode_AdministrationDomainName(value.administration_domain_name, __utils.BER) : undefined),
            (value.network_address ? __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_NetworkAddress, __utils.BER)(value.network_address, __utils.BER) : undefined),
            (value.terminal_identifier ? __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_TerminalIdentifier, __utils.BER)(value.terminal_identifier, __utils.BER) : undefined),
            (value.private_domain_name ? __utils._encode_explicit(asn1.ASN1TagClass.context, 2, () => _encode_PrivateDomainName, __utils.BER)(value.private_domain_name, __utils.BER) : undefined),
            (value.organization_name ? __utils._encode_explicit(asn1.ASN1TagClass.context, 3, () => _encode_OrganizationName, __utils.BER)(value.organization_name, __utils.BER) : undefined),
            (value.numeric_user_identifier ? __utils._encode_explicit(asn1.ASN1TagClass.context, 4, () => _encode_NumericUserIdentifier, __utils.BER)(value.numeric_user_identifier, __utils.BER) : undefined),
            (value.personal_name ? __utils._encode_explicit(asn1.ASN1TagClass.context, 5, () => _encode_PersonalName, __utils.BER)(value.personal_name, __utils.BER) : undefined),
            (value.organizational_unit_names ? __utils._encode_explicit(asn1.ASN1TagClass.context, 6, () => _encode_OrganizationalUnitNames, __utils.BER)(value.organizational_unit_names, __utils.BER) : undefined)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_BuiltInDomainDefinedAttribute = function (el: asn1.ASN1Element): BuiltInDomainDefinedAttribute {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("BuiltInDomainDefinedAttribute contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
...
export const _decode_BuiltInDomainDefinedAttributes = __utils._decodeSequenceOf<BuiltInDomainDefinedAttribute>(() => _decode_BuiltInDomainDefinedAttribute);
export const _encode_BuiltInDomainDefinedAttributes = __utils._encodeSequenceOf<BuiltInDomainDefinedAttribute>(() => _encode_BuiltInDomainDefinedAttribute, __utils.BER);
...
export const _decode_ExtensionAttribute = function (el: asn1.ASN1Element): ExtensionAttribute {
    ...
    extension_attribute_type = __utils._decode_explicit<asn1.INTEGER>(() => __utils._decodeInteger)(sequence[0]);
    extension_attribute_value = __utils._decode_explicit<asn1.ASN1Element>(() => __utils._decodeAny)(sequence[1]);
    // TODO: Validate values.
...
export const _encode_ExtensionAttribute = function (value: ExtensionAttribute, elGetter: __utils.ASN1Encoder<ExtensionAttribute>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => __utils._encodeInteger, __utils.BER)(value.extension_attribute_type, __utils.BER),
            __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => __utils._encodeAny, __utils.BER)(value.extension_attribute_value, __utils.BER)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_ExtensionAttributes = __utils._decodeSetOf<ExtensionAttribute>(() => _decode_ExtensionAttribute);
export const _encode_ExtensionAttributes = __utils._encodeSetOf<ExtensionAttribute>(() => _encode_ExtensionAttribute, __utils.BER);


export class ORAddress {
    constructor (
        readonly built_in_standard_attributes: BuiltInStandardAttributes,
        readonly built_in_domain_defined_attributes: BuiltInDomainDefinedAttributes | undefined,
...
export const _decode_ORAddress = function (el: asn1.ASN1Element): ORAddress {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "built-in-standard-attributes": (_el: asn1.ASN1Element): void => { built_in_standard_attributes = _decode_BuiltInStandardAttributes(_el); },
        "built-in-domain-defined-attributes": (_el: asn1.ASN1Element): void => { built_in_domain_defined_attributes = _decode_BuiltInDomainDefinedAttributes(_el); },
        "extension-attributes": (_el: asn1.ASN1Element): void => { extension_attributes = _decode_ExtensionAttributes(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_ORAddress = function (value: ORAddress, elGetter: __utils.ASN1Encoder<ORAddress>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            _encode_BuiltInStandardAttributes(value.built_in_standard_attributes, __utils.BER),
            (value.built_in_domain_defined_attributes ? _encode_BuiltInDomainDefinedAttributes(value.built_in_domain_defined_attributes, __utils.BER) : undefined),
            (value.extension_attributes ? _encode_ExtensionAttributes(value.extension_attributes, __utils.BER) : undefined)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_UniversalOrBMPString_character_encoding = __utils._decode_inextensible_choice<UniversalOrBMPString_character_encoding>({
    "UNIVERSAL 30": [ "two_octets", __utils._decodeBMPString ],
    "UNIVERSAL 28": [ "four_octets", __utils._decodeUniversalString ]
});
export const _encode_UniversalOrBMPString_character_encoding = __utils._encode_choice<UniversalOrBMPString_character_encoding>({
...
export const _decode_UniversalOrBMPString = function (el: asn1.ASN1Element): UniversalOrBMPString {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "character-encoding": (_el: asn1.ASN1Element): void => { character_encoding = _decode_UniversalOrBMPString_character_encoding(_el); },
        "iso-639-language-code": (_el: asn1.ASN1Element): void => { iso_639_language_code = __utils._decodePrintableString(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_set(el, callbacks,
...
export const _encode_UniversalOrBMPString = function (value: UniversalOrBMPString, elGetter: __utils.ASN1Encoder<UniversalOrBMPString>): asn1.ASN1Element {
    return __utils._encodeSet(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            _encode_UniversalOrBMPString_character_encoding(value.character_encoding, __utils.BER),
            (value.iso_639_language_code ? __utils._encodePrintableString(value.iso_639_language_code, __utils.BER) : undefined)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_TeletexPersonalName = function (el: asn1.ASN1Element): TeletexPersonalName {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "surname": (_el: asn1.ASN1Element): void => { surname = __utils._decode_explicit<asn1.TeletexString>(() => __utils._decodeTeletexString)(_el); },
        "given-name": (_el: asn1.ASN1Element): void => { given_name = __utils._decode_explicit<asn1.TeletexString>(() => __utils._decodeTeletexString)(_el); },
        "initials": (_el: asn1.ASN1Element): void => { initials = __utils._decode_explicit<asn1.TeletexString>(() => __utils._decodeTeletexString)(_el); },
        "generation-qualifier": (_el: asn1.ASN1Element): void => { generation_qualifier = __utils._decode_explicit<asn1.TeletexString>(() => __utils._decodeTeletexString)(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_set(el, callbacks,
...
export const _encode_TeletexPersonalName = function (value: TeletexPersonalName, elGetter: __utils.ASN1Encoder<TeletexPersonalName>): asn1.ASN1Element {
    return __utils._encodeSet(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => __utils._encodeTeletexString, __utils.BER)(value.surname, __utils.BER),
            (value.given_name ? __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => __utils._encodeTeletexString, __utils.BER)(value.given_name, __utils.BER) : undefined),
            (value.initials ? __utils._encode_explicit(asn1.ASN1TagClass.context, 2, () => __utils._encodeTeletexString, __utils.BER)(value.initials, __utils.BER) : undefined),
            (value.generation_qualifier ? __utils._encode_explicit(asn1.ASN1TagClass.context, 3, () => __utils._encodeTeletexString, __utils.BER)(value.generation_qualifier, __utils.BER) : undefined)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_UniversalPersonalName = function (el: asn1.ASN1Element): UniversalPersonalName {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "surname": (_el: asn1.ASN1Element): void => { surname = __utils._decode_explicit<UniversalOrBMPString>(() => _decode_UniversalOrBMPString)(_el); },
        "given-name": (_el: asn1.ASN1Element): void => { given_name = __utils._decode_explicit<UniversalOrBMPString>(() => _decode_UniversalOrBMPString)(_el); },
        "initials": (_el: asn1.ASN1Element): void => { initials = __utils._decode_explicit<UniversalOrBMPString>(() => _decode_UniversalOrBMPString)(_el); },
        "generation-qualifier": (_el: asn1.ASN1Element): void => { generation_qualifier = __utils._decode_explicit<UniversalOrBMPString>(() => _decode_UniversalOrBMPString)(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_set(el, callbacks,
...
export const _encode_UniversalPersonalName = function (value: UniversalPersonalName, elGetter: __utils.ASN1Encoder<UniversalPersonalName>): asn1.ASN1Element {
    return __utils._encodeSet(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_UniversalOrBMPString, __utils.BER)(value.surname, __utils.BER),
            (value.given_name ? __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_UniversalOrBMPString, __utils.BER)(value.given_name, __utils.BER) : undefined),
            (value.initials ? __utils._encode_explicit(asn1.ASN1TagClass.context, 2, () => _encode_UniversalOrBMPString, __utils.BER)(value.initials, __utils.BER) : undefined),
            (value.generation_qualifier ? __utils._encode_explicit(asn1.ASN1TagClass.context, 3, () => _encode_UniversalOrBMPString, __utils.BER)(value.generation_qualifier, __utils.BER) : undefined)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_TeletexOrganizationalUnitName = __utils._decodeTeletexString;
export const _encode_TeletexOrganizationalUnitName = __utils._encodeTeletexString;


export type TeletexOrganizationalUnitNames = TeletexOrganizationalUnitName[]; // SequenceOfType
export const _decode_TeletexOrganizationalUnitNames = __utils._decodeSequenceOf<TeletexOrganizationalUnitName>(() => _decode_TeletexOrganizationalUnitName);
export const _encode_TeletexOrganizationalUnitNames = __utils._encodeSequenceOf<TeletexOrganizationalUnitName>(() => _encode_TeletexOrganizationalUnitName, __utils.BER);
...
export const _decode_UniversalOrganizationalUnitNames = __utils._decodeSequenceOf<UniversalOrganizationalUnitName>(() => _decode_UniversalOrganizationalUnitName);
export const _encode_UniversalOrganizationalUnitNames = __utils._encodeSequenceOf<UniversalOrganizationalUnitName>(() => _encode_UniversalOrganizationalUnitName, __utils.BER);
...
export type PhysicalDeliveryCountryName =
    { x121_dcc_code: asn1.NumericString }
    | { iso_3166_alpha2_code: asn1.PrintableString };
export const _decode_PhysicalDeliveryCountryName = __utils._decode_inextensible_choice<PhysicalDeliveryCountryName>({
    "UNIVERSAL 18": [ "x121_dcc_code", __utils._decodeNumericString ],
    "UNIVERSAL 19": [ "iso_3166_alpha2_code", __utils._decodePrintableString ]
});
export const _encode_PhysicalDeliveryCountryName = __utils._encode_choice<PhysicalDeliveryCountryName>({
    "x121_dcc_code": __utils._encodeNumericString,
    "iso_3166_alpha2_code": __utils._encodePrintableString,
}, __utils.BER);
...
export const _decode_PostalCode = __utils._decode_inextensible_choice<PostalCode>({
...
export const _decode_PDSParameter = function (el: asn1.ASN1Element): PDSParameter {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "printable-string": (_el: asn1.ASN1Element): void => { printable_string = __utils._decodePrintableString(_el); },
        "teletex-string": (_el: asn1.ASN1Element): void => { teletex_string = __utils._decodeTeletexString(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_set(el, callbacks,
...
export const _encode_PDSParameter = function (value: PDSParameter, elGetter: __utils.ASN1Encoder<PDSParameter>): asn1.ASN1Element {
    return __utils._encodeSet(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            (value.printable_string ? __utils._encodePrintableString(value.printable_string, __utils.BER) : undefined),
            (value.teletex_string ? __utils._encodeTeletexString(value.teletex_string, __utils.BER) : undefined)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_UnformattedPostalAddress = function (el: asn1.ASN1Element): UnformattedPostalAddress {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "printable-address": (_el: asn1.ASN1Element): void => { printable_address = __utils._decodeSequenceOf<asn1.PrintableString>(() => __utils._decodePrintableString)(_el); },
        "teletex-string": (_el: asn1.ASN1Element): void => { teletex_string = __utils._decodeTeletexString(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_set(el, callbacks,
...
export const _encode_UnformattedPostalAddress = function (value: UnformattedPostalAddress, elGetter: __utils.ASN1Encoder<UnformattedPostalAddress>): asn1.ASN1Element {
    return __utils._encodeSet(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            (value.printable_address ? __utils._encodeSequenceOf<asn1.PrintableString>(() => __utils._encodePrintableString, __utils.BER)(value.printable_address, __utils.BER) : undefined),
            (value.teletex_string ? __utils._encodeTeletexString(value.teletex_string, __utils.BER) : undefined)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_ExtendedNetworkAddress = __utils._decode_inextensible_choice<ExtendedNetworkAddress>({
    "UNIVERSAL 16": [ "e163_4_address", _decode_ExtendedNetworkAddress_e163_4_address ],
    "CONTEXT 0": [ "psap_address", __utils._decode_explicit<PresentationAddress>(() => _decode_PresentationAddress) ]
});
export const _encode_ExtendedNetworkAddress = __utils._encode_choice<ExtendedNetworkAddress>({
    "e163_4_address": _encode_ExtendedNetworkAddress_e163_4_address,
    "psap_address": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_PresentationAddress, __utils.BER),
}, __utils.BER);
...
export const _decode_TeletexDomainDefinedAttribute = function (el: asn1.ASN1Element): TeletexDomainDefinedAttribute {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("TeletexDomainDefinedAttribute contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "type";
    sequence[1].name = "value";
...
export const _decode_TeletexDomainDefinedAttributes = __utils._decodeSequenceOf<TeletexDomainDefinedAttribute>(() => _decode_TeletexDomainDefinedAttribute);
export const _encode_TeletexDomainDefinedAttributes = __utils._encodeSequenceOf<TeletexDomainDefinedAttribute>(() => _encode_TeletexDomainDefinedAttribute, __utils.BER);
...
export const _decode_UniversalDomainDefinedAttribute = function (el: asn1.ASN1Element): UniversalDomainDefinedAttribute {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("UniversalDomainDefinedAttribute contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "type";
    sequence[1].name = "value";
...
export const _decode_UniversalDomainDefinedAttributes = __utils._decodeSequenceOf<UniversalDomainDefinedAttribute>(() => _decode_UniversalDomainDefinedAttribute);
export const _encode_UniversalDomainDefinedAttributes = __utils._encodeSequenceOf<UniversalDomainDefinedAttribute>(() => _encode_UniversalDomainDefinedAttribute, __utils.BER);
