/**
 * @module MTSAbstractService
 * @summary The ASN.1 module `MTSAbstractService`.
 * @description
 *
 * OID: joint-iso-itu-t.mhs.mts.modules.mts-abstract-service.version-1999
 * IRI: undefined
 * EXTENSIBLE: false
        ...
        _cached_decoder_for_PersonalName = function (
            ...
            const callbacks: $.DecodingMap = {
                surname: (_el: _Element): void => {
                    surname = $._decode_implicit<PrintableString>(
                        () => $._decodePrintableString
                    )(_el);
                },
                "given-name": (_el: _Element): void => {
                    given_name = $._decode_implicit<PrintableString>(
                        () => $._decodePrintableString
                    )(_el);
                },
                initials: (_el: _Element): void => {
                    initials = $._decode_implicit<PrintableString>(
                        () => $._decodePrintableString
                    )(_el);
                },
                "generation-qualifier": (_el: _Element): void => {
                    generation_qualifier = $._decode_implicit<PrintableString>(
                        () => $._decodePrintableString
                    )(_el);
                },
            };
        ...
        _cached_decoder_for_BuiltInStandardAttributes = function (
            ...
            const callbacks: $.DecodingMap = {
                ...
                "terminal-identifier": (_el: _Element): void => {
                    terminal_identifier = $._decode_implicit<
                        TerminalIdentifier
                    >(() => _decode_TerminalIdentifier)(_el);
                },
                "private-domain-name": (_el: _Element): void => {
                    private_domain_name = $._decode_implicit<PrivateDomainName>(
                ...
                "numeric-user-identifier": (_el: _Element): void => {
                    numeric_user_identifier = $._decode_implicit<
                        NumericUserIdentifier
                ...
                "organizational-unit-names": (_el: _Element): void => {
                    organizational_unit_names = $._decode_implicit<
                        OrganizationalUnitNames
...
export function _decode_TeletexPersonalName(el: _Element) {
    if (!_cached_decoder_for_TeletexPersonalName) {
        _cached_decoder_for_TeletexPersonalName = function (
            ...
            const callbacks: $.DecodingMap = {
                surname: (_el: _Element): void => {
                    surname = $._decode_implicit<TeletexString>(
                        () => $._decodeTeletexString
                    )(_el);
                },
                "given-name": (_el: _Element): void => {
                    given_name = $._decode_implicit<TeletexString>(
                        () => $._decodeTeletexString
                    )(_el);
                },
                initials: (_el: _Element): void => {
                    initials = $._decode_implicit<TeletexString>(
                        () => $._decodeTeletexString
                    )(_el);
                },
                "generation-qualifier": (_el: _Element): void => {
                    generation_qualifier = $._decode_implicit<TeletexString>(
                        () => $._decodeTeletexString
                    )(_el);
                },
            };
    ...
    if (!_cached_decoder_for_UniversalPersonalName) {
        _cached_decoder_for_UniversalPersonalName = function (
            ...
            const callbacks: $.DecodingMap = {
                ...
                "generation-qualifier": (_el: _Element): void => {
                    generation_qualifier = $._decode_implicit<
                        UniversalOrBMPString
