...
export {
    SecurityClassification,
    SecurityClassification_confidential /* IMPORTED_NAMED_INTEGER */,
    SecurityClassification_restricted /* IMPORTED_NAMED_INTEGER */,
    SecurityClassification_secret /* IMPORTED_NAMED_INTEGER */,
    SecurityClassification_top_secret /* IMPORTED_NAMED_INTEGER */,
    SecurityClassification_unclassified /* IMPORTED_NAMED_INTEGER */,
    SecurityClassification_unmarked /* IMPORTED_NAMED_INTEGER */,
    _decode_SecurityClassification,
    _encode_SecurityClassification,
} from "../EnhancedSecurity/SecurityClassification.ta";
export {
