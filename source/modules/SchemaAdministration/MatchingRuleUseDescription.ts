...
class MatchingRuleUseDescription {
    ...
    public static fromElement (value: ASN1Element): MatchingRuleUseDescription {
        ...
        let information!: ObjectIdentifier[];
        const specification: ConstructedElementSpecification[] = [
            ...
            },
            {
                ...
                callback: (el: ASN1Element): void => {
                    // TODO: Validate tags.
                    information = el.set.map((i) => i.objectIdentifier);
                },
            },
        ];
    ...
    public toElement (): DERElement {
        const informationElement: DERElement = DERElement.fromSet(this.information.map((i) => new DERElement(
