...
import DITContextUseInformation from "./DITContextUseInformation";
 ...
 */
export default
class DITContextUseDescription {
    constructor (
    ...
    public static fromElement (value: DERElement): DITContextUseDescription {
        ...
        const specification: ConstructedElementSpecification[] = [
            ...
            },
            {
                ...
                tagNumber: 0,
                callback: (el: ASN1Element): void => {
                    information = DITContextUseInformation.fromElement(el as DERElement);
                },
            },
        ];
