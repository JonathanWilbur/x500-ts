...
class RDNSequence {
    ...
    public static fromElement (value: DERElement): RDNSequence {
        ...
        case 0: break;
        case -1: throw new errors.X500Error("Invalid tag class on RDNSequence");
        case -2: throw new errors.X500Error("Invalid construction on RDNSequence");
        case -3: throw new errors.X500Error("Invalid tag number on RDNSequence");
        default: throw new errors.X500Error("Undefined error when validating RDNSequence tag");
        }
