...
import { PwdHistory, _encode_PwdHistory, _decode_PwdHistory } from "../InformationFramework/PwdHistory.ta";
...
export
function pwdHistory (passwordAttribute: ATTRIBUTE, historyMatch: MATCHING_RULE, id: OBJECT_IDENTIFIER): ATTRIBUTE {
    return {
        class: "ATTRIBUTE",
        decoderFor: {
