...
class RelativeDistinguishedName {
    constructor (
        ...
        if (value.length < 1) {
            throw new errors.X500Error("RelativeDistinguishedName must contain at least one AttributeTypeAndValue.");
        }
    }
    ...
    public static fromElement (value: DERElement): RelativeDistinguishedName {
        ...
        case 0: break;
        case -1: throw new errors.X500Error("Invalid tag class on RelativeDistinguishedName");
        case -2: throw new errors.X500Error("Invalid construction on RelativeDistinguishedName");
        case -3: throw new errors.X500Error("Invalid tag number on RelativeDistinguishedName");
        default: throw new errors.X500Error("Undefined error when validating RelativeDistinguishedName tag");
        }
