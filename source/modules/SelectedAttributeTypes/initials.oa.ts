...
import { id_at_initials } from "../SelectedAttributeTypes/id-at-initials.va";
...
/* START_OF_SYMBOL_DEFINITION initials */
/**
 * @summary initials
 * @description
 *
 ...
 */
export const initials: ATTRIBUTE<UnboundedDirectoryString> = {
    class: "ATTRIBUTE",
    decoderFor: {
...
/* END_OF_SYMBOL_DEFINITION initials */
