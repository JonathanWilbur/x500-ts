...
export {
    Period_days_bitDay,
    Period_days_bitDay_friday /* IMPORTED_BIT */,
    Period_days_bitDay_monday /* IMPORTED_BIT */,
    Period_days_bitDay_saturday /* IMPORTED_BIT */,
    Period_days_bitDay_sunday /* IMPORTED_BIT */,
    Period_days_bitDay_thursday /* IMPORTED_BIT */,
    Period_days_bitDay_tuesday /* IMPORTED_BIT */,
    Period_days_bitDay_wednesday /* IMPORTED_BIT */,
    _decode_Period_days_bitDay,
    _encode_Period_days_bitDay,
} from "../SelectedAttributeTypes/Period-days-bitDay.ta";
export {
