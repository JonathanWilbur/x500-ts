...
export {
    PreferredDeliveryMethod_Item,
    PreferredDeliveryMethod_Item_any_delivery_method /* IMPORTED_NAMED_INTEGER */,
    PreferredDeliveryMethod_Item_g3_facsimile_delivery /* IMPORTED_NAMED_INTEGER */,
    PreferredDeliveryMethod_Item_g4_facsimile_delivery /* IMPORTED_NAMED_INTEGER */,
    PreferredDeliveryMethod_Item_ia5_terminal_delivery /* IMPORTED_NAMED_INTEGER */,
    PreferredDeliveryMethod_Item_mhs_delivery /* IMPORTED_NAMED_INTEGER */,
    PreferredDeliveryMethod_Item_physical_delivery /* IMPORTED_NAMED_INTEGER */,
    PreferredDeliveryMethod_Item_telephone_delivery /* IMPORTED_NAMED_INTEGER */,
    PreferredDeliveryMethod_Item_teletex_delivery /* IMPORTED_NAMED_INTEGER */,
    PreferredDeliveryMethod_Item_telex_delivery /* IMPORTED_NAMED_INTEGER */,
    PreferredDeliveryMethod_Item_videotex_delivery /* IMPORTED_NAMED_INTEGER */,
    _decode_PreferredDeliveryMethod_Item,
    _encode_PreferredDeliveryMethod_Item,
} from "../SelectedAttributeTypes/PreferredDeliveryMethod-Item.ta";
