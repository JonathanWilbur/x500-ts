...
class UnboundedDirectoryString {
    ...
    public static fromElement (value: ASN1Element): UnboundedDirectoryString {
        ...
        if (value.construction !== ASN1Construction.primitive) {
            throw new errors.X500Error("UnboundedDirectoryString must be of primitive construction");
        }
        ...
        default:
            throw new errors.X500Error("UnboundedDirectoryString was constituted of an invalid CHOICE");
        }
    }
