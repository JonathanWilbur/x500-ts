...
class PolicyInformation {
    ...
    public static fromElement (value: ASN1Element): PolicyInformation {
        ...
        case -2: throw new errors.X500Error("Invalid construction on PolicyInformation");
        case -3: throw new errors.X500Error("Invalid tag number on PolicyInformation");
        ...
        case -2: throw new errors.X500Error("Invalid construction on PolicyInformation.policyIdentifier");
        case -3: throw new errors.X500Error("Invalid tag number on PolicyInformation.policyIdentifier");
        default: throw new errors.X500Error("Undefined error when validating PolicyInformation.policyIdentifier tag");
        }
        ...
        */
        if (!DERElement.isInCanonicalOrder(policyInformationElements.slice(fixedPositionElementsEncountered))) {
            throw new errors.X500Error("Extended elements of PolicyInformation were not in canonical order");
        }
