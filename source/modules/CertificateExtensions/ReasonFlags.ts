...
class ReasonFlags {
    ...
    public static fromElement (value: DERElement): ReasonFlags {
        ...
        case -2: throw new errors.X500Error("Invalid construction on ReasonFlags");
        case -3: throw new errors.X500Error("Invalid tag number on ReasonFlags");
        default: throw new errors.X500Error("Undefined error when validating ReasonFlags tag");
        }
