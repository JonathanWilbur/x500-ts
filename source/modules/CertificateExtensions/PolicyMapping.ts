...
class PolicyMapping {
    ...
    public static fromElement (value: DERElement): PolicyMapping {
        ...
        case -2: throw new errors.X500Error("Invalid construction on inner sequence of PolicyMappingsSyntax");
        case -3: throw new errors.X500Error("Invalid tag number on inner sequence of PolicyMappingsSyntax");
        default: {
            throw new errors.X500Error("Undefined error when validating inner sequence of PolicyMappingsSyntax tag");
        }
        }
