...
export {
    AltNameType_builtinNameForm,
    AltNameType_builtinNameForm_directoryName /* IMPORTED_ENUMERATION_ITEM */,
    AltNameType_builtinNameForm_dNSName /* IMPORTED_ENUMERATION_ITEM */,
    AltNameType_builtinNameForm_ediPartyName /* IMPORTED_ENUMERATION_ITEM */,
    AltNameType_builtinNameForm_iPAddress /* IMPORTED_ENUMERATION_ITEM */,
    AltNameType_builtinNameForm_registeredId /* IMPORTED_ENUMERATION_ITEM */,
    AltNameType_builtinNameForm_rfc822Name /* IMPORTED_ENUMERATION_ITEM */,
    AltNameType_builtinNameForm_uniformResourceIdentifier /* IMPORTED_ENUMERATION_ITEM */,
    AltNameType_builtinNameForm_x400Address /* IMPORTED_ENUMERATION_ITEM */,
    _decode_AltNameType_builtinNameForm,
    _encode_AltNameType_builtinNameForm,
