...
class DistributionPoint {
    ...
    public static fromElement (value: ASN1Element): DistributionPoint {
        ...
        case 0: break;
        case -1: throw new errors.X500Error("Invalid tag class on DistributionPoint");
        case -2: throw new errors.X500Error("Invalid construction on DistributionPoint");
        case -3: throw new errors.X500Error("Invalid tag number on DistributionPoint");
        default: throw new errors.X500Error("Undefined error when validating DistributionPoint tag");
        }

        const distributionPointElements: ASN1Element[] = value.sequence;
        ...
        distributionPointElements.forEach((element) => {
            ...
            case (1): { // reasons
                if (element.construction !== ASN1Construction.primitive) {
                    throw new errors.X500Error("DistributionPoint.reasons may not be constructed.");
                }
    ...
    public toElement (): DERElement {
        const distributionPointElements: ASN1Element[] = [];
