...
class IssuingDistPointSyntax {
    ...
    public static fromElement (value: ASN1Element): IssuingDistPointSyntax {
        ...
        case -2: throw new errors.X500Error("Invalid construction on IssuingDistPointSyntax");
        case -3: throw new errors.X500Error("Invalid tag number on IssuingDistPointSyntax");
        default: throw new errors.X500Error("Undefined error when validating IssuingDistPointSyntax tag");
        }
        ...
        issuingDistPointSyntaxElements.forEach((element) => {
            if (!lastEncounteredTagNumber) {
                ...
                throw new errors.X500Error("Elements out of order in IssuingDistPointSyntax.");
            }
