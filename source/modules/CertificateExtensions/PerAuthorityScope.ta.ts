...
export {
    OnlyCertificateTypes,
    OnlyCertificateTypes_attribute /* IMPORTED_BIT */,
    OnlyCertificateTypes_authority /* IMPORTED_BIT */,
    OnlyCertificateTypes_user /* IMPORTED_BIT */,
    _decode_OnlyCertificateTypes,
    _encode_OnlyCertificateTypes,
} from "../CertificateExtensions/OnlyCertificateTypes.ta";
export {
    ReasonFlags,
    ReasonFlags_aACompromise /* IMPORTED_BIT */,
    ReasonFlags_affiliationChanged /* IMPORTED_BIT */,
    ReasonFlags_cACompromise /* IMPORTED_BIT */,
    ReasonFlags_certificateHold /* IMPORTED_BIT */,
    ReasonFlags_cessationOfOperation /* IMPORTED_BIT */,
    ReasonFlags_keyCompromise /* IMPORTED_BIT */,
    ReasonFlags_privilegeWithdrawn /* IMPORTED_BIT */,
    ReasonFlags_superseded /* IMPORTED_BIT */,
    ReasonFlags_unused /* IMPORTED_BIT */,
    ReasonFlags_weakAlgorithmOrKey /* IMPORTED_BIT */,
    _decode_ReasonFlags,
    _encode_ReasonFlags,
} from "../CertificateExtensions/ReasonFlags.ta";
