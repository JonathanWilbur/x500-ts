...
class AuthorityKeyIdentifier {
    ...
    public static fromElement (value: DERElement): AuthorityKeyIdentifier {
        ...
        case -2: throw new errors.X500Error("Invalid construction on AuthorityKeyIdentifier");
        case -3: throw new errors.X500Error("Invalid tag number on AuthorityKeyIdentifier");
        ...
        ) throw new errors.X500Error("Invalid number of elements in AuthorityKeyIdentifier");
        ...
        case 0: break;
        case -1: throw new errors.X500Error("Invalid tag class on AuthorityKeyIdentifier.keyIdentifier");
        case -2: throw new errors.X500Error("Invalid construction on AuthorityKeyIdentifier.keyIdentifier");
        case -3: throw new errors.X500Error("Invalid tag number on AuthorityKeyIdentifier.keyIdentifier");
        default: throw new errors.X500Error("Undefined error when validating AuthorityKeyIdentifier.keyIdentifier tag");
        }
        ...
        if (authorityKeyIdentifierElements.length === 3) {
            ...
            case 0: break;
            case -1: throw new errors.X500Error("Invalid tag class on AuthorityKeyIdentifier.authorityCertIssuer");
            case -2: throw new errors.X500Error("Invalid construction on AuthorityKeyIdentifier.authorityCertIssuer");
            case -3: throw new errors.X500Error("Invalid tag number on AuthorityKeyIdentifier.authorityCertIssuer");
            default: {
            ...
            case 0: break;
            case -1: {
                throw new errors.X500Error("Invalid tag class on AuthorityKeyIdentifier.authorityCertSerialNumber");
            }
            case -2: {
                throw new errors.X500Error("Invalid construction on AuthorityKeyIdentifier.authorityCertSerialNumber");
            }
            case -3: {
                throw new errors.X500Error("Invalid tag number on AuthorityKeyIdentifier.authorityCertSerialNumber");
            }
            default: {
                throw new errors.X500Error(
