...
export {
    EnvelopedData_error,
    EnvelopedData_error_noReason /* IMPORTED_ENUMERATION_ITEM */,
    _decode_EnvelopedData_error,
    _encode_EnvelopedData_error,
...
export {
    SignedData_error,
    SignedData_error_invalidContentComponent /* IMPORTED_ENUMERATION_ITEM */,
    SignedData_error_missingContent /* IMPORTED_ENUMERATION_ITEM */,
    SignedData_error_missingContentComponent /* IMPORTED_ENUMERATION_ITEM */,
    SignedData_error_noReason /* IMPORTED_ENUMERATION_ITEM */,
    SignedData_error_signedDataContectTypeExpected /* IMPORTED_ENUMERATION_ITEM */,
    SignedData_error_unsupportedHashAlgorithm /* IMPORTED_ENUMERATION_ITEM */,
    SignedData_error_wrongSignedDataVersion /* IMPORTED_ENUMERATION_ITEM */,
    _decode_SignedData_error,
    _encode_SignedData_error,
