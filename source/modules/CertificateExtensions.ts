...
export { anyPolicy } from "./CertificateExtensions/anyPolicy.va";
export { associatedInformation } from "./CertificateExtensions/associatedInformation.oa";
export {
    AttributesSyntax,
...
} from "./CertificateExtensions/BaseDistance.ta";
export {
    BaseRevocationInfo,
...
export {
    ...
    _extension_additions_list_spec_for_CertificateExactAssertion,
    _root_component_type_list_1_spec_for_CertificateExactAssertion,
    _root_component_type_list_2_spec_for_CertificateExactAssertion,
...
export {
    ...
    _extension_additions_list_spec_for_CertificateGroupNumberRange,
    _root_component_type_list_1_spec_for_CertificateGroupNumberRange,
    _root_component_type_list_2_spec_for_CertificateGroupNumberRange,
...
export { certificateListMatch } from "./CertificateExtensions/certificateListMatch.oa";
export { certificateMatch } from "./CertificateExtensions/certificateMatch.oa";
export {
...
export { certificatePairMatch } from "./CertificateExtensions/certificatePairMatch.oa";
...
export { crlScope } from "./CertificateExtensions/crlScope.oa";
export {
    CRLScopeSyntax,
...
export { enhancedCertificateMatch } from "./CertificateExtensions/enhancedCertificateMatch.oa";
...
export { inhibitAnyPolicy } from "./CertificateExtensions/inhibitAnyPolicy.oa";
...
export { nameConstraints } from "./CertificateExtensions/nameConstraints.oa";
export {
...
export {
    ...
    OnlyCertificateTypes_attribute,
    OnlyCertificateTypes_authority,
    OnlyCertificateTypes_user,
...
export {
    ...
    _extension_additions_list_spec_for_PkiPathMatchSyntax,
    _root_component_type_list_1_spec_for_PkiPathMatchSyntax,
    _root_component_type_list_2_spec_for_PkiPathMatchSyntax,
...
export {
    ...
    _extension_additions_list_spec_for_PolicyMappingsSyntax_Item,
    _root_component_type_list_1_spec_for_PolicyMappingsSyntax_Item,
    _root_component_type_list_2_spec_for_PolicyMappingsSyntax_Item,
...
export { protRestrict } from "./CertificateExtensions/protRestrict.oa";
export {
    ProtRestriction,
...
export {
    ReasonFlags,
    ReasonFlags_aACompromise,
    ReasonFlags_affiliationChanged,
    ReasonFlags_cACompromise,
    ReasonFlags_certificateHold,
    ReasonFlags_cessationOfOperation,
    ReasonFlags_keyCompromise,
    ReasonFlags_privilegeWithdrawn,
    ReasonFlags_superseded,
    ReasonFlags_unused,
    ReasonFlags_weakAlgorithmOrKey,
    _decode_ReasonFlags,
    _encode_ReasonFlags,
...
export {
    ...
    _extension_additions_list_spec_for_SubjectAltPublicKeyInfo,
    _root_component_type_list_1_spec_for_SubjectAltPublicKeyInfo,
    _root_component_type_list_2_spec_for_SubjectAltPublicKeyInfo,
...
export { subjectKeyIdentifier } from "./CertificateExtensions/subjectKeyIdentifier.oa";
export {
