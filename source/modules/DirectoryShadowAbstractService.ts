...
export { All_operations_consumer_initiated } from "./DirectoryShadowAbstractService/All-operations-consumer-initiated.osa";
export { All_operations_supplier_initiated } from "./DirectoryShadowAbstractService/All-operations-supplier-initiated.osa";
export {
    AreaSpecification,
    _decode_AreaSpecification,
    _encode_AreaSpecification,
    _extension_additions_list_spec_for_AreaSpecification,
    _root_component_type_list_1_spec_for_AreaSpecification,
    _root_component_type_list_2_spec_for_AreaSpecification,
...
export {
    ...
    _extension_additions_list_spec_for_ModificationParameter,
    _root_component_type_list_1_spec_for_ModificationParameter,
    _root_component_type_list_2_spec_for_ModificationParameter,
...
export {
    ...
    ShadowProblem_inactiveAgreement,
    ShadowProblem_insufficientResources,
    ShadowProblem_invalidAgreementID,
    ShadowProblem_invalidInformationReceived,
    ShadowProblem_invalidSequencing,
    ShadowProblem_missedPrevious,
...
export {
    ...
    _extension_additions_list_spec_for_SubordinateChanges,
    _root_component_type_list_1_spec_for_SubordinateChanges,
    _root_component_type_list_2_spec_for_SubordinateChanges,
...
export {
    ...
    _extension_additions_list_spec_for_UpdateWindow,
