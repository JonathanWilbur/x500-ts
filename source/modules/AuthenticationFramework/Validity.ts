...
class Validity {
    ...
    public static fromElement (value: DERElement): Validity {
        ...
        case 0: break;
        case -1: throw new errors.X500Error("Invalid tag class on validity");
        case -2: throw new errors.X500Error("Invalid construction on validity");
        ...
        case -2: throw new errors.X500Error("Invalid construction on validity.notBefore");
        case -3: throw new errors.X500Error("Invalid tag number on validity.notBefore");
        default: throw new errors.X500Error("Undefined error when validating validity.notBefore tag");
        }
