...
class Certificate {
    ...
    public static fromElement (value: ASN1Element): Certificate {
        ...
        case -2: throw new errors.X500Error("Invalid construction on Certificate");
        case -3: throw new errors.X500Error("Invalid tag number on Certificate");
        ...
        case -2: throw new errors.X500Error("Invalid construction on Certificate.signatureValue");
        case -3: throw new errors.X500Error("Invalid tag number on Certificate.signatureValue");
        default: throw new errors.X500Error("Undefined error when validating Certificate.signatureValue tag");
        }
