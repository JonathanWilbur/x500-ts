...
class SubjectPublicKeyInfo {
    ...
    public static fromElement (value: DERElement): SubjectPublicKeyInfo {
        ...
        case 0: break;
        case -1: throw new errors.X500Error("Invalid tag class on SubjectPublicKeyInfo");
        case -2: throw new errors.X500Error("Invalid construction on SubjectPublicKeyInfo");
        case -3: throw new errors.X500Error("Invalid tag number on SubjectPublicKeyInfo");
        ...
        case -2: throw new errors.X500Error("Invalid construction on SubjectPublicKeyInfo.subjectPublicKey");
        case -3: throw new errors.X500Error("Invalid tag number on SubjectPublicKeyInfo.subjectPublicKey");
        default: {
            throw new errors.X500Error("Undefined error when validating SubjectPublicKeyInfo.subjectPublicKey tag");
        }
        }
    ...
    public toElement (): DERElement {
        if (this.algorithm === undefined) throw new errors.X500Error("Algorithm is undefined");
