...
class Extension { // implements Byteable,Elementable {
    ...
    public static fromElement (value: DERElement): Extension {
        ...
        case 0: break;
        case -1: throw new errors.X500Error("Invalid tag class on Extension");
        case -2: throw new errors.X500Error("Invalid construction on Extension");
        case -3: throw new errors.X500Error("Invalid tag number on Extension");
        ...
        if (extensionElements.length > 3) {
            ...
            throw new errors.X500Error("An Extension encoded fewer than two elements");
        }
        ...
        case 0: break;
        case -1: throw new errors.X500Error("Invalid tag class on Extension.identifier");
        case -2: throw new errors.X500Error("Invalid construction on Extension.identifier");
        case -3: throw new errors.X500Error("Invalid tag number on Extension.identifier");
        default: throw new errors.X500Error("Undefined error when validating Extension.identifier tag");
        }
        ...
        if (extensionElements.length === 3) {
            ...
            case -2: throw new errors.X500Error("Invalid construction on Extension.critical");
            case -3: throw new errors.X500Error("Invalid tag number on Extension.critical");
            default: throw new errors.X500Error("Undefined error when validating Extension.critical tag");
            }
        ...
        case -2: throw new errors.X500Error("Invalid construction on Extension.extnValue");
        case -3: throw new errors.X500Error("Invalid tag number on Extension.extnValue");
    ...
    public toElement (): DERElement {
        if (this.extnID === undefined) throw new errors.X500Error("extnID is undefined");
