...
class AlgorithmIdentifier {
    ...
    public static fromElement (value: DERElement): AlgorithmIdentifier {
        ...
        if (algorithmIdentifierElements.length === 0) {
            throw new errors.X500Error("AlgorithmIdentifier may not contain zero elements.");
        }
        if (algorithmIdentifierElements.length > 2) {
            throw new errors.X500Error("Too many elements in AlgorithmIdentifier.");
        }
        ...
        case 0: break;
        case -1: throw new errors.X500Error("Invalid tag class on AlgorithmIdentifier.algorithm");
        case -2: throw new errors.X500Error("Invalid construction on AlgorithmIdentifier.algorithm");
        case -3: throw new errors.X500Error("Invalid tag number on AlgorithmIdentifier.algorithm");
        default: throw new errors.X500Error("Undefined error when validating AlgorithmIdentifier.algorithm tag");
        }
