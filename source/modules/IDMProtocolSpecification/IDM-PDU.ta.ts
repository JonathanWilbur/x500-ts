...
export {
    Abort,
    Abort_connectionFailed /* IMPORTED_ENUMERATION_ITEM */,
    Abort_invalidPDU /* IMPORTED_ENUMERATION_ITEM */,
    Abort_invalidProtocol /* IMPORTED_ENUMERATION_ITEM */,
    Abort_mistypedPDU /* IMPORTED_ENUMERATION_ITEM */,
    Abort_reasonNotSpecified /* IMPORTED_ENUMERATION_ITEM */,
    Abort_resourceLimitation /* IMPORTED_ENUMERATION_ITEM */,
    Abort_unboundRequest /* IMPORTED_ENUMERATION_ITEM */,
    _decode_Abort,
    _encode_Abort,
    _enum_for_Abort,
} from "../IDMProtocolSpecification/Abort.ta";
...
export {
    TLSResponse,
    TLSResponse_operationsError /* IMPORTED_ENUMERATION_ITEM */,
    TLSResponse_protocolError /* IMPORTED_ENUMERATION_ITEM */,
    TLSResponse_success /* IMPORTED_ENUMERATION_ITEM */,
    TLSResponse_unavailable /* IMPORTED_ENUMERATION_ITEM */,
    _decode_TLSResponse,
    _encode_TLSResponse,
