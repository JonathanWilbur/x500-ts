...
export {
    ...
    _extension_additions_list_spec_for_AbandonArgumentData,
    _root_component_type_list_1_spec_for_AbandonArgumentData,
    _root_component_type_list_2_spec_for_AbandonArgumentData,
...
export {
    ...
    _decode_BindKeyInfo,
    _encode_BindKeyInfo,
} from "./DirectoryAbstractService/BindKeyInfo.ta";
...
export { family_information } from "./DirectoryAbstractService/family-information.oa";
export {
    FamilyEntries,
    _decode_FamilyEntries,
    _encode_FamilyEntries,
    _extension_additions_list_spec_for_FamilyEntries,
    _root_component_type_list_1_spec_for_FamilyEntries,
    _root_component_type_list_2_spec_for_FamilyEntries,
...
export {
    ...
    _extension_additions_list_spec_for_FilterItem_substrings,
    _root_component_type_list_1_spec_for_FilterItem_substrings,
    _root_component_type_list_2_spec_for_FilterItem_substrings,
...
export {
    ...
    _decode_LdapResult,
    _encode_LdapResult,
} from "./DirectoryAbstractService/LdapResult.ta";
export {
    LdapResultData,
...
export {
    ...
    _extension_additions_list_spec_for_ModifyRights_Item,
    _root_component_type_list_1_spec_for_ModifyRights_Item,
    _root_component_type_list_2_spec_for_ModifyRights_Item,
...
export {
    ...
    _extension_additions_list_spec_for_ServiceControls_manageDSAITPlaneRef,
    _root_component_type_list_1_spec_for_ServiceControls_manageDSAITPlaneRef,
    _root_component_type_list_2_spec_for_ServiceControls_manageDSAITPlaneRef,
...
export {
    ...
    _extension_additions_list_spec_for_TypeAndContextAssertion,
    _root_component_type_list_1_spec_for_TypeAndContextAssertion,
    _root_component_type_list_2_spec_for_TypeAndContextAssertion,
