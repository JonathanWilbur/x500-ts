...
import { OPTIONALLY_PROTECTED, _get_decoder_for_OPTIONALLY_PROTECTED, _get_encoder_for_OPTIONALLY_PROTECTED } from "../EnhancedSecurity/OPTIONALLY-PROTECTED.ta";
import { Chained_ArgumentType_OPTIONALLY_PROTECTED_Parameter1, _decode_Chained_ArgumentType_OPTIONALLY_PROTECTED_Parameter1, _encode_Chained_ArgumentType_OPTIONALLY_PROTECTED_Parameter1  } from "./Chained-ArgumentType-OPTIONALLY-PROTECTED-Parameter1.ta";
import { Chained_ResultType_OPTIONALLY_PROTECTED_Parameter1, _decode_Chained_ResultType_OPTIONALLY_PROTECTED_Parameter1, _encode_Chained_ResultType_OPTIONALLY_PROTECTED_Parameter1 } from "./Chained-ResultType-OPTIONALLY-PROTECTED-Parameter1.ta";
