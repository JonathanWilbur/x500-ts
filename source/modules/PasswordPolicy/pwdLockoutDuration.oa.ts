...
import { id_oa_pwdLockoutDuration } from "../PasswordPolicy/id-oa-pwdLockoutDuration.va";
...
/* START_OF_SYMBOL_DEFINITION pwdLockoutDuration */
/**
 ...
 */
export const pwdLockoutDuration: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
...
/* END_OF_SYMBOL_DEFINITION pwdLockoutDuration */
