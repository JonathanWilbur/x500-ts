...
import { id_oa_pwdFailureDuration } from "../PasswordPolicy/id-oa-pwdFailureDuration.va";
...
/* START_OF_SYMBOL_DEFINITION pwdFailureDuration */
/**
 ...
 */
export const pwdFailureDuration: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
...
/* END_OF_SYMBOL_DEFINITION pwdFailureDuration */
