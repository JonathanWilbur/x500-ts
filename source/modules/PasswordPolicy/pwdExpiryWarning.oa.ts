...
import { id_oa_pwdExpiryWarning } from "../PasswordPolicy/id-oa-pwdExpiryWarning.va";
...
/* START_OF_SYMBOL_DEFINITION pwdExpiryWarning */
/**
 ...
 */
export const pwdExpiryWarning: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
...
/* END_OF_SYMBOL_DEFINITION pwdExpiryWarning */
