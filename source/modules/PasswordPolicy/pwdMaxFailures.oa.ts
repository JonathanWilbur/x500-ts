...
import { id_oa_pwdMaxFailures } from "../PasswordPolicy/id-oa-pwdMaxFailures.va";
...
/* START_OF_SYMBOL_DEFINITION pwdMaxFailures */
/**
 ...
 */
export const pwdMaxFailures: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
...
/* END_OF_SYMBOL_DEFINITION pwdMaxFailures */
