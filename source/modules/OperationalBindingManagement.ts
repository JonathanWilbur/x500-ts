...
export {
    ...
    OpBindingErrorParam_problem_modificationNotAllowed,
    OpBindingErrorParam_problem_notAllowedForRole,
...
export {
    ...
    _extension_additions_list_spec_for_OperationalBindingID,
    _root_component_type_list_1_spec_for_OperationalBindingID,
    _root_component_type_list_2_spec_for_OperationalBindingID,
