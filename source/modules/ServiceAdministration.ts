...
export {
    ...
    _decode_EntryLimit,
    _encode_EntryLimit,
    _extension_additions_list_spec_for_EntryLimit,
    _root_component_type_list_1_spec_for_EntryLimit,
    _root_component_type_list_2_spec_for_EntryLimit,
...
export {
    ...
    _decode_MatchingUse,
    _encode_MatchingUse,
    _extension_additions_list_spec_for_MatchingUse,
    _root_component_type_list_1_spec_for_MatchingUse,
    _root_component_type_list_2_spec_for_MatchingUse,
...
export { SEARCH_RULE } from "./ServiceAdministration/SEARCH-RULE.oca";
export {
    SearchRule,
    _decode_SearchRule,
    _encode_SearchRule,
...
export {
    ...
    _extension_additions_list_spec_for_SearchRuleId,
