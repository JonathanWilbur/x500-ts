...
export {
    Abort_reason,
    Abort_reason_invalid_ppdu_parameter_value /* IMPORTED_NAMED_INTEGER */,
    Abort_reason_reason_not_specified /* IMPORTED_NAMED_INTEGER */,
    Abort_reason_unexpected_ppdu /* IMPORTED_NAMED_INTEGER */,
    Abort_reason_unexpected_ppdu_parameter /* IMPORTED_NAMED_INTEGER */,
    Abort_reason_unexpected_session_service_primitive /* IMPORTED_NAMED_INTEGER */,
    Abort_reason_unrecognized_ppdu /* IMPORTED_NAMED_INTEGER */,
    Abort_reason_unrecognized_ppdu_parameter /* IMPORTED_NAMED_INTEGER */,
    _decode_Abort_reason,
    _encode_Abort_reason,
} from "../OSIProtocolSpecification/Abort-reason.ta";
export {
    Event_identifier,
    Event_identifier_arp_PPDU /* IMPORTED_NAMED_INTEGER */,
    Event_identifier_aru_PPDU /* IMPORTED_NAMED_INTEGER */,
    Event_identifier_cpa_PPDU /* IMPORTED_NAMED_INTEGER */,
    Event_identifier_cpr_PPDU /* IMPORTED_NAMED_INTEGER */,
    Event_identifier_cp_PPDU /* IMPORTED_NAMED_INTEGER */,
    Event_identifier_s_release_confirm /* IMPORTED_NAMED_INTEGER */,
    Event_identifier_s_release_indication /* IMPORTED_NAMED_INTEGER */,
    Event_identifier_td_PPDU /* IMPORTED_NAMED_INTEGER */,
    _decode_Event_identifier,
    _encode_Event_identifier,
} from "../OSIProtocolSpecification/Event-identifier.ta";
