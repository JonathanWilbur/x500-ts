...
let _cached_decoder_for_OsiUnbind_fully_encoded_data_Item_presentation_data_values: $.ASN1Decoder<OsiUnbind_fully_encoded_data_Item_presentation_data_values> | null = null;
...
export function _decode_OsiUnbind_fully_encoded_data_Item_presentation_data_values(
    ...
    if (
        ...
        _cached_decoder_for_OsiUnbind_fully_encoded_data_Item_presentation_data_values = $._decode_inextensible_choice<OsiUnbind_fully_encoded_data_Item_presentation_data_values>(
            {
                "CONTEXT 0": [
                    "single_ASN1_type",
...
let _cached_encoder_for_OsiUnbind_fully_encoded_data_Item_presentation_data_values: $.ASN1Encoder<OsiUnbind_fully_encoded_data_Item_presentation_data_values> | null = null;
...
export function _encode_OsiUnbind_fully_encoded_data_Item_presentation_data_values(
    ...
    elGetter: $.ASN1Encoder<OsiUnbind_fully_encoded_data_Item_presentation_data_values>
) {
    if (
        !_cached_encoder_for_OsiUnbind_fully_encoded_data_Item_presentation_data_values
    ) {
        _cached_encoder_for_OsiUnbind_fully_encoded_data_Item_presentation_data_values = $._encode_choice<OsiUnbind_fully_encoded_data_Item_presentation_data_values>(
            {
