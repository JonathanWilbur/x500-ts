...
export const _decode_OsiBind_mode_selector = function (
    el: asn1.ASN1Element
...
export const _decode_OsiBind_normal_mode_parameters_protocol_version =
    __utils._decodeBitString;
export const _encode_OsiBind_normal_mode_parameters_protocol_version =
...
export const _decode_Context_list_Item = function (
    el: asn1.ASN1Element
): Context_list_Item {
    ...
    transfer_syntax_name_list = __utils._decodeSequenceOf<Transfer_syntax_name>(
...
export const _encode_Context_list_Item = function (
...
export const _decode_Context_list = __utils._decodeSequenceOf<
    Context_list_Item
>(() => _decode_Context_list_Item);
export const _encode_Context_list = __utils._encodeSequenceOf<
    Context_list_Item
...
export const _decode_OsiBind_normal_mode_parameters_user_data_fully_encoded_data_Item_presentation_data_values = __utils._decode_inextensible_choice<
...
export const _encode_OsiBind_normal_mode_parameters_user_data_fully_encoded_data_Item_presentation_data_values = __utils._encode_choice<
    OsiBind_normal_mode_parameters_user_data_fully_encoded_data_Item_presentation_data_values
>(
    {
...
export const _decode_OsiBind_normal_mode_parameters_user_data_fully_encoded_data_Item = function (
    el: asn1.ASN1Element
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "presentation-context-identifier": (_el: asn1.ASN1Element): void => {
            presentation_context_identifier = _decode_Presentation_context_identifier(
                _el
            );
        },
...
export const _encode_OsiBind_normal_mode_parameters_user_data_fully_encoded_data_Item = function (
    ...
    return __utils._encodeSequence(
        ([] as (asn1.ASN1Element | undefined)[])
            .concat([
                /* IF_ABSENT  */ value.transfer_syntax_name === undefined
                    ? undefined
...
export const _decode_OsiBind_normal_mode_parameters_user_data = __utils._decode_inextensible_choice<
...
export const _encode_OsiBind_normal_mode_parameters_user_data = __utils._encode_choice<
    OsiBind_normal_mode_parameters_user_data
>(
    {
...
export const _default_value_for_OsiBind_normal_mode_parameters__protocol_version = new Uint8ClampedArray(
    [asn1.TRUE_BIT]
);
export const _decode_OsiBind_normal_mode_parameters = function (
    el: asn1.ASN1Element
): OsiBind_normal_mode_parameters {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
    let protocol_version: asn1.OPTIONAL<OsiBind_normal_mode_parameters_protocol_version> = _default_value_for_OsiBind_normal_mode_parameters__protocol_version;
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "calling-presentation-selector": (_el: asn1.ASN1Element): void => {
            calling_presentation_selector = __utils._decode_explicit<
                Presentation_selector
            >(() => _decode_Presentation_selector)(_el);
        },
        "called-presentation-selector": (_el: asn1.ASN1Element): void => {
        ...
        "user-data": (_el: asn1.ASN1Element): void => {
            user_data = _decode_OsiBind_normal_mode_parameters_user_data(_el);
        },
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(
...
export const _encode_OsiBind_normal_mode_parameters = function (
        ...
        ([] as (asn1.ASN1Element | undefined)[])
            .concat([
                ...
                __utils.deepEq(
                    ...
                    _default_value_for_OsiBind_normal_mode_parameters__protocol_version
                )
                    ? undefined
                ...
                undefined
                    ...
                    : __utils._encode_explicit(
                          ...
                          __utils.BER
                      )(value.calling_presentation_selector, __utils.BER),
                ...
                undefined
                    ...
                    : __utils._encode_explicit(
                          ...
                          () => _encode_Presentation_selector,
                          __utils.BER
                      )(value.called_presentation_selector, __utils.BER),
                /* REQUIRED   */ __utils._encode_explicit(
                    asn1.ASN1TagClass.context,
                    4,
                    () => _encode_Context_list,
                    __utils.BER
                )(value.presentation_context_definition_list, __utils.BER),
...
export const _decode_OsiBind = function (el: asn1.ASN1Element): OsiBind {
    ...
    const callbacks: __utils.DecodingMap = {
        "mode-selector": (_el: asn1.ASN1Element): void => {
            mode_selector = __utils._decode_explicit<OsiBind_mode_selector>(
...
export const _encode_OsiBind = function (
    value: OsiBind,
...
export const _decode_Association_informationBind = __utils._decodeSequenceOf<
    asn1.EXTERNAL
>(() => __utils._decodeExternal);
export const _encode_Association_informationBind = __utils._encodeSequenceOf<
    asn1.EXTERNAL
...
export const _default_value_for_AARQ_apdu__protocol_version = new Uint8ClampedArray(
    [asn1.TRUE_BIT]
);
export const _decode_AARQ_apdu = __utils._decode_explicit<AARQ_apdu>(
    () =>
        function (el: asn1.ASN1Element): AARQ_apdu {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            let protocol_version: asn1.OPTIONAL<AARQ_apdu_protocol_version> = _default_value_for_AARQ_apdu__protocol_version;
            ...
            const callbacks: __utils.DecodingMap = {
                ...
                "application-context-name": (_el: asn1.ASN1Element): void => {
                ...
                "called-AE-qualifier": (_el: asn1.ASN1Element): void => {
                ...
                "calling-AE-qualifier": (_el: asn1.ASN1Element): void => {
                ...
                "implementation-information": (_el: asn1.ASN1Element): void => {
...
export const _encode_AARQ_apdu = __utils._encode_explicit(
    asn1.ASN1TagClass.application,
    0,
    () =>
        function (
            ...
            return __utils._encodeSequence(
                ([] as (asn1.ASN1Element | undefined)[])
                    .concat([
                        ...
                        __utils.deepEq(
                            value.protocol_version,
                            _default_value_for_AARQ_apdu__protocol_version
                        )
                            ? undefined
                            : __utils._encode_explicit(
                                  asn1.ASN1TagClass.context,
                        ...
                        undefined
                            ...
                            : __utils._encode_explicit(
                                  ...
                                  () => _encode_RelativeDistinguishedName,
                                  __utils.BER
                              )(value.calling_AE_qualifier, __utils.BER),
                        ...
                        undefined
                            ...
                            : __utils._encode_explicit(
                                  ...
                                  __utils.BER
                              )(value.implementation_information, __utils.BER),
                        /* REQUIRED   */ __utils._encode_explicit(
                            asn1.ASN1TagClass.context,
                            30,
...
export const _decode_TheOsiBind = __utils._decode_explicit<TheOsiBind>(
    () => __utils._decodeAny
);
export const _encode_TheOsiBind = __utils._encode_explicit(
    asn1.ASN1TagClass.context,
    16,
    () => __utils._encodeAny,
    __utils.BER
...
export const _decode_OsiBindResult_mode_selector = function (
    el: asn1.ASN1Element
...
export const _decode_OsiBindResult_normal_mode_parameters_protocol_version =
    __utils._decodeBitString;
export const _encode_OsiBindResult_normal_mode_parameters_protocol_version =
    __utils._encodeBitString;
...
export const _decode_OsiBindResult_normal_mode_parameters_presentation_context_definition_result_list_Item = function (
    el: asn1.ASN1Element
    ...
    transfer_syntax_name = __utils._decode_explicit<Transfer_syntax_name>(
        () => _decode_Transfer_syntax_name
    )(sequence[1]);
    // TODO: Validate values.
...
export const _encode_OsiBindResult_normal_mode_parameters_presentation_context_definition_result_list_Item = function (
...
export const _decode_OsiBindResult_normal_mode_parameters_user_data_fully_encoded_data_Item_presentation_data_values = __utils._decode_inextensible_choice<
...
export const _encode_OsiBindResult_normal_mode_parameters_user_data_fully_encoded_data_Item_presentation_data_values = __utils._encode_choice<
    OsiBindResult_normal_mode_parameters_user_data_fully_encoded_data_Item_presentation_data_values
>(
    {
        single_ASN1_type: __utils._encode_explicit(
...
export const _decode_OsiBindResult_normal_mode_parameters_user_data_fully_encoded_data_Item = function (
    el: asn1.ASN1Element
...
export const _encode_OsiBindResult_normal_mode_parameters_user_data_fully_encoded_data_Item = function (
...
export const _decode_OsiBindResult_normal_mode_parameters_user_data = __utils._decode_inextensible_choice<
...
export const _encode_OsiBindResult_normal_mode_parameters_user_data = __utils._encode_choice<
    OsiBindResult_normal_mode_parameters_user_data
>(
    {
        fully_encoded_data: __utils._encode_explicit(
...
export const _default_value_for_OsiBindResult_normal_mode_parameters__protocol_version = new Uint8ClampedArray(
    [asn1.TRUE_BIT]
);
export const _decode_OsiBindResult_normal_mode_parameters = function (
    el: asn1.ASN1Element
): OsiBindResult_normal_mode_parameters {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
    let protocol_version: asn1.OPTIONAL<OsiBindResult_normal_mode_parameters_protocol_version> = _default_value_for_OsiBindResult_normal_mode_parameters__protocol_version;
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "responding-presentation-selector": (_el: asn1.ASN1Element): void => {
...
export const _encode_OsiBindResult_normal_mode_parameters = function (
    ...
    return __utils._encodeSequence(
        ([] as (asn1.ASN1Element | undefined)[])
            .concat([
                ...
                __utils.deepEq(
                    value.protocol_version,
                    _default_value_for_OsiBindResult_normal_mode_parameters__protocol_version
                )
                    ? undefined
                    : __utils._encode_explicit(
                          asn1.ASN1TagClass.context,
                ...
                undefined
                    ...
                    : __utils._encode_explicit(
                          ...
                          () => _encode_Presentation_selector,
                          __utils.BER
                      )(value.responding_presentation_selector, __utils.BER),
                /* REQUIRED   */ __utils._encode_explicit(
                    asn1.ASN1TagClass.context,
                    5,
                    () =>
...
export const _decode_OsiBindResult = function (
    el: asn1.ASN1Element
): OsiBindResult {
    /* START_OF_SET_COMPONENT_DECLARATIONS */
...
export const _encode_OsiBindResult = function (
    value: OsiBindResult,
...
export const _decode_Associate_source_diagnostic_acse_service_user =
    __utils._decodeInteger;
export const _encode_Associate_source_diagnostic_acse_service_user =
    __utils._encodeInteger;
...
export const _decode_Associate_source_diagnostic_acse_service_provider =
    __utils._decodeInteger;
export const _encode_Associate_source_diagnostic_acse_service_provider =
    __utils._encodeInteger;
...
export const _decode_Associate_source_diagnostic = __utils._decode_inextensible_choice<
    Associate_source_diagnostic
>({
    "CONTEXT 1": [
        "acse_service_user",
        __utils._decode_explicit<Associate_source_diagnostic_acse_service_user>(
...
export const _encode_Associate_source_diagnostic = __utils._encode_choice<
    Associate_source_diagnostic
>(
    {
...
export const _decode_Association_informationBindRes = __utils._decodeSequenceOf<
    asn1.EXTERNAL
>(() => __utils._decodeExternal);
export const _encode_Association_informationBindRes = __utils._encodeSequenceOf<
    asn1.EXTERNAL
>(() => __utils._encodeExternal, __utils.BER);
...
export const _default_value_for_AARE_apdu__protocol_version = new Uint8ClampedArray(
    [asn1.TRUE_BIT]
);
export const _decode_AARE_apdu = __utils._decode_explicit<AARE_apdu>(
    () =>
        function (el: asn1.ASN1Element): AARE_apdu {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            let protocol_version: asn1.OPTIONAL<AARE_apdu_protocol_version> = _default_value_for_AARE_apdu__protocol_version;
            let application_context_name!: Application_context_name;
            ...
            const callbacks: __utils.DecodingMap = {
                ...
                "result-source-diagnostic": (_el: asn1.ASN1Element): void => {
                    result_source_diagnostic = __utils._decode_explicit<
                        Associate_source_diagnostic
                    >(() => _decode_Associate_source_diagnostic)(_el);
                },
                "responding-AP-title": (_el: asn1.ASN1Element): void => {
                    responding_AP_title = __utils._decode_explicit<Name>(
                        () => _decode_Name
                    )(_el);
                },
                "responding-AE-qualifier": (_el: asn1.ASN1Element): void => {
                ...
                "user-information": (_el: asn1.ASN1Element): void => {
                    ...
                    >(() => _decode_Association_informationBindRes)(_el);
                },
            };
            /* END_OF_CALLBACKS_MAP */
            __utils._parse_sequence(
...
export const _encode_AARE_apdu = __utils._encode_explicit(
    asn1.ASN1TagClass.application,
    1,
    () =>
        function (
            ...
            return __utils._encodeSequence(
                ([] as (asn1.ASN1Element | undefined)[])
                    .concat([
                        ...
                        __utils.deepEq(
                            value.protocol_version,
                            _default_value_for_AARE_apdu__protocol_version
                        )
                            ? undefined
                            : __utils._encode_explicit(
                                  asn1.ASN1TagClass.context,
                        ...
                        undefined
                            ...
                            : __utils._encode_explicit(
                                  ...
                                  () => _encode_RelativeDistinguishedName,
                                  __utils.BER
                              )(value.responding_AE_qualifier, __utils.BER),
...
export const _decode_TheOsiBindRes = __utils._decode_explicit<TheOsiBindRes>(
    () => __utils._decodeAny
);
export const _encode_TheOsiBindRes = __utils._encode_explicit(
    asn1.ASN1TagClass.context,
    17,
    () => __utils._encodeAny,
    __utils.BER
...
export const _decode_OsiBindError_normal_mode_parameters_protocol_version =
    __utils._decodeBitString;
export const _encode_OsiBindError_normal_mode_parameters_protocol_version =
    __utils._encodeBitString;
...
export const _decode_Result_list_Item = function (
    el: asn1.ASN1Element
): Result_list_Item {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
    let result!: Result;
...
export const _encode_Result_list_Item = function (
...
export const _decode_Result_list = __utils._decodeSequenceOf<Result_list_Item>(
    () => _decode_Result_list_Item
);
export const _encode_Result_list = __utils._encodeSequenceOf<Result_list_Item>(
...
export const _decode_OsiBindError_normal_mode_parameters_user_data_fully_encoded_data_Item_presentation_data_values = __utils._decode_inextensible_choice<
...
export const _encode_OsiBindError_normal_mode_parameters_user_data_fully_encoded_data_Item_presentation_data_values = __utils._encode_choice<
    OsiBindError_normal_mode_parameters_user_data_fully_encoded_data_Item_presentation_data_values
>(
    {
        single_ASN1_type: __utils._encode_explicit(
...
export const _decode_OsiBindError_normal_mode_parameters_user_data_fully_encoded_data_Item = function (
    el: asn1.ASN1Element
...
export const _encode_OsiBindError_normal_mode_parameters_user_data_fully_encoded_data_Item = function (
...
export const _decode_OsiBindError_normal_mode_parameters_user_data = __utils._decode_inextensible_choice<
...
export const _encode_OsiBindError_normal_mode_parameters_user_data = __utils._encode_choice<
    OsiBindError_normal_mode_parameters_user_data
>(
    {
        fully_encoded_data: __utils._encode_explicit(
...
export const _default_value_for_OsiBindError_normal_mode_parameters__protocol_version = new Uint8ClampedArray(
    [asn1.TRUE_BIT]
);
export const _decode_OsiBindError_normal_mode_parameters = function (
    el: asn1.ASN1Element
): OsiBindError_normal_mode_parameters {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
    let protocol_version: asn1.OPTIONAL<OsiBindError_normal_mode_parameters_protocol_version> = _default_value_for_OsiBindError_normal_mode_parameters__protocol_version;
    let responding_presentation_selector: asn1.OPTIONAL<Presentation_selector>;
...
export const _encode_OsiBindError_normal_mode_parameters = function (
    ...
    return __utils._encodeSequence(
        ([] as (asn1.ASN1Element | undefined)[])
            .concat([
                ...
                __utils.deepEq(
                    value.protocol_version,
                    _default_value_for_OsiBindError_normal_mode_parameters__protocol_version
                )
                    ? undefined
                    : __utils._encode_explicit(
                          asn1.ASN1TagClass.context,
...
export const _decode_OsiBindError = __utils._decode_inextensible_choice<
    OsiBindError
>({
    "UNIVERSAL 16": [
        "normal_mode_parameters",
...
export const _decode_Association_informationBindErr = __utils._decodeSequenceOf<
    asn1.EXTERNAL
>(() => __utils._decodeExternal);
export const _encode_Association_informationBindErr = __utils._encodeSequenceOf<
    asn1.EXTERNAL
>(() => __utils._encodeExternal, __utils.BER);
...
export const _default_value_for_AAREerr_apdu__protocol_version = new Uint8ClampedArray(
    [asn1.TRUE_BIT]
);
export const _decode_AAREerr_apdu = __utils._decode_explicit<AAREerr_apdu>(
    () =>
        function (el: asn1.ASN1Element): AAREerr_apdu {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            let protocol_version: asn1.OPTIONAL<AAREerr_apdu_protocol_version> = _default_value_for_AAREerr_apdu__protocol_version;
            let application_context_name!: Application_context_name;
            let result!: Associate_result;
            let result_source_diagnostic!: Associate_source_diagnostic;
            let responding_AP_title: asn1.OPTIONAL<Name>;
            ...
            const callbacks: __utils.DecodingMap = {
                ...
                "user-information": (_el: asn1.ASN1Element): void => {
                    ...
                    >(() => _decode_Association_informationBindErr)(_el);
                },
            };
            /* END_OF_CALLBACKS_MAP */
            __utils._parse_sequence(
...
export const _encode_AAREerr_apdu = __utils._encode_explicit(
    asn1.ASN1TagClass.application,
    1,
    () =>
        function (
            ...
            return __utils._encodeSequence(
                ([] as (asn1.ASN1Element | undefined)[])
                    .concat([
                        ...
                        __utils.deepEq(
                            value.protocol_version,
                            _default_value_for_AAREerr_apdu__protocol_version
                        )
                            ? undefined
                            : __utils._encode_explicit(
                                  asn1.ASN1TagClass.context,
...
export const _decode_TheOsiBindErr = __utils._decode_explicit<TheOsiBindErr>(
    () => __utils._decodeAny
);
export const _encode_TheOsiBindErr = __utils._encode_explicit(
    asn1.ASN1TagClass.context,
    18,
    () => __utils._encodeAny,
    __utils.BER
...
export const _decode_OsiUnbind_fully_encoded_data_Item_presentation_data_values = __utils._decode_inextensible_choice<
...
export const _encode_OsiUnbind_fully_encoded_data_Item_presentation_data_values = __utils._encode_choice<
    OsiUnbind_fully_encoded_data_Item_presentation_data_values
>(
    {
        single_ASN1_type: __utils._encode_explicit(
...
export const _decode_OsiUnbind_fully_encoded_data_Item = function (
    el: asn1.ASN1Element
...
export const _encode_OsiUnbind_fully_encoded_data_Item = function (
...
export const _decode_OsiUnbind = __utils._decode_inextensible_choice<OsiUnbind>(
    {
        "APPLICATION 1": [
            ...
            __utils._decode_explicit<OsiUnbind_fully_encoded_data_Item[]>(() =>
                __utils._decodeSequenceOf<OsiUnbind_fully_encoded_data_Item>(
...
export const _encode_OsiUnbind = __utils._encode_choice<OsiUnbind>(
    {
        fully_encoded_data: __utils._encode_explicit(
            ...
            1,
            () =>
                __utils._encodeSequenceOf<OsiUnbind_fully_encoded_data_Item>(
...
export const _decode_TheOsiUnbind = __utils._decode_explicit<TheOsiUnbind>(
    () =>
        function (el: asn1.ASN1Element): TheOsiUnbind {
            ...
            const callbacks: __utils.DecodingMap = {
                reason: (_el: asn1.ASN1Element): void => {
                    reason = __utils._decode_explicit<Release_request_reason>(
...
export const _decode_OsiUnbindResult_fully_encoded_data_Item_presentation_data_values = __utils._decode_inextensible_choice<
...
export const _encode_OsiUnbindResult_fully_encoded_data_Item_presentation_data_values = __utils._encode_choice<
    OsiUnbindResult_fully_encoded_data_Item_presentation_data_values
>(
    {
        single_ASN1_type: __utils._encode_explicit(
...
export const _decode_OsiUnbindResult_fully_encoded_data_Item = function (
    el: asn1.ASN1Element
...
export const _encode_OsiUnbindResult_fully_encoded_data_Item = function (
...
export const _decode_OsiUnbindResult = __utils._decode_inextensible_choice<
    OsiUnbindResult
>({
    "APPLICATION 1": [
        "fully_encoded_data",
        __utils._decode_explicit<OsiUnbindResult_fully_encoded_data_Item[]>(
            () =>
                __utils._decodeSequenceOf<
                    OsiUnbindResult_fully_encoded_data_Item
...
export const _decode_TheOsiUnbindRes = __utils._decode_explicit<
    TheOsiUnbindRes
>(
    () =>
        function (el: asn1.ASN1Element): TheOsiUnbindRes {
            ...
            const callbacks: __utils.DecodingMap = {
                reason: (_el: asn1.ASN1Element): void => {
                    reason = __utils._decode_explicit<Release_response_reason>(
...
export const _decode_OsiOperation_fully_encoded_data_Item_presentation_data_values = __utils._decode_inextensible_choice<
...
export const _encode_OsiOperation_fully_encoded_data_Item_presentation_data_values = __utils._encode_choice<
    OsiOperation_fully_encoded_data_Item_presentation_data_values
>(
    {
        single_ASN1_type: __utils._encode_explicit(
...
export const _decode_OsiOperation_fully_encoded_data_Item = function (
    el: asn1.ASN1Element
...
export const _encode_OsiOperation_fully_encoded_data_Item = function (
...
export const _decode_OsiOperation = __utils._decode_inextensible_choice<
    OsiOperation
>({
    "APPLICATION 1": [
        "fully_encoded_data",
        __utils._decode_explicit<OsiOperation_fully_encoded_data_Item[]>(() =>
            __utils._decodeSequenceOf<OsiOperation_fully_encoded_data_Item>(
...
export const _encode_OsiOperation = __utils._encode_choice<OsiOperation>(
    {
        fully_encoded_data: __utils._encode_explicit(
            ...
            1,
            () =>
                __utils._encodeSequenceOf<OsiOperation_fully_encoded_data_Item>(
...
export const _decode_OsiReq = __utils._decode_explicit<OsiReq>(
    () =>
...
export const _encode_OsiReq = __utils._encode_explicit(
    asn1.ASN1TagClass.context,
    1,
    () =>
        function (
...
export const _decode_OsiRes_result = function (
    el: asn1.ASN1Element
): OsiRes_result {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
...
export const _encode_OsiRes_result = function (
    value: OsiRes_result,
    ...
    return __utils._encodeSequence(
        ([] as (asn1.ASN1Element | undefined)[])
            .concat([
                ...
                /* REQUIRED   */ __utils._encodeAny(value.result, __utils.BER),
            ])
            .filter(
                (c: asn1.ASN1Element | undefined): boolean => !!c
            ) as asn1.ASN1Element[],
...
export const _decode_OsiRes = __utils._decode_explicit<OsiRes>(
    () =>
...
export const _encode_OsiRes = __utils._encode_explicit(
    asn1.ASN1TagClass.context,
    2,
    () =>
        function (
...
export const _decode_OsiErr = __utils._decode_explicit<OsiErr>(
    () =>
...
export const _encode_OsiErr = __utils._encode_explicit(
    asn1.ASN1TagClass.context,
    3,
    () =>
        function (
...
export type OsiRej_problem =
    ...
    | asn1.ASN1Element;
export const _decode_OsiRej_problem = __utils._decode_extensible_choice<
    OsiRej_problem
>({
    "CONTEXT 0": [
        "general",
        __utils._decode_explicit<GeneralProblem>(() => _decode_GeneralProblem),
    ],
    "CONTEXT 1": [
        "invoke",
        __utils._decode_explicit<InvokeProblem>(() => _decode_InvokeProblem),
    ],
    "CONTEXT 2": [
        "returnResult",
...
export const _decode_OsiRej = __utils._decode_explicit<OsiRej>(
    () =>
...
export const _encode_OsiRej = __utils._encode_explicit(
    asn1.ASN1TagClass.context,
    4,
    () =>
        function (
...
export type OsiDirectoryOperation =
    ...
    | { error: OsiErr }
    | { reject: OsiRej };
export const _decode_OsiDirectoryOperation = __utils._decode_inextensible_choice<
...
export const _encode_OsiDirectoryOperation = __utils._encode_choice<
    OsiDirectoryOperation
>(
    {
...
export const _decode_Presentation_context_identifier_list_Item = function (
    el: asn1.ASN1Element
...
export const _encode_Presentation_context_identifier_list_Item = function (
...
export const _decode_Presentation_context_identifier_list = __utils._decodeSequenceOf<
    Presentation_context_identifier_list_Item
>(() => _decode_Presentation_context_identifier_list_Item);
export const _encode_Presentation_context_identifier_list = __utils._encodeSequenceOf<
    Presentation_context_identifier_list_Item
...
export const _decode_ARU_PPDU_normal_mode_parameters_user_data_fully_encoded_data_Item_presentation_data_values = __utils._decode_inextensible_choice<
...
export const _encode_ARU_PPDU_normal_mode_parameters_user_data_fully_encoded_data_Item_presentation_data_values = __utils._encode_choice<
    ARU_PPDU_normal_mode_parameters_user_data_fully_encoded_data_Item_presentation_data_values
>(
    {
        single_ASN1_type: __utils._encode_explicit(
...
export const _decode_ARU_PPDU_normal_mode_parameters_user_data_fully_encoded_data_Item = function (
    el: asn1.ASN1Element
...
export const _encode_ARU_PPDU_normal_mode_parameters_user_data_fully_encoded_data_Item = function (
...
export const _decode_ARU_PPDU_normal_mode_parameters_user_data = __utils._decode_inextensible_choice<
...
export const _encode_ARU_PPDU_normal_mode_parameters_user_data = __utils._encode_choice<
    ARU_PPDU_normal_mode_parameters_user_data
>(
    {
        fully_encoded_data: __utils._encode_explicit(
...
export const _decode_ARU_PPDU_normal_mode_parameters = function (
    el: asn1.ASN1Element
...
export const _encode_ARU_PPDU_normal_mode_parameters = function (
        ...
        ([] as (asn1.ASN1Element | undefined)[])
            .concat([
                /* REQUIRED   */ __utils._encode_explicit(
                    ...
                    __utils.BER
                )(value.presentation_context_identifier_list, __utils.BER),
...
export const _decode_ARP_PPDU = function (el: asn1.ASN1Element): ARP_PPDU {
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "event-identifier": (_el: asn1.ASN1Element): void => {
            event_identifier = __utils._decode_explicit<Event_identifier>(
...
export const _encode_ARP_PPDU = function (
    value: ARP_PPDU,
...
export type PresentationAbort = { aru_ppdu: ARU_PPDU } | { arp_ppdu: ARP_PPDU };
export const _decode_PresentationAbort = __utils._decode_inextensible_choice<
    PresentationAbort
>({
    "CONTEXT 0": ["aru_ppdu", _decode_ARU_PPDU],
    "UNIVERSAL 16": ["arp_ppdu", _decode_ARP_PPDU],
});
export const _encode_PresentationAbort = __utils._encode_choice<
    PresentationAbort
>(
    {
...
export const _decode_ABRT_apdu = __utils._decode_explicit<ABRT_apdu>(
    () =>
...
export const _encode_ABRT_apdu = __utils._encode_explicit(
    asn1.ASN1TagClass.application,
    4,
    () =>
        function (
