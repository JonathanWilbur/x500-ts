...
export const _decode_UUIDPair = function (el: asn1.ASN1Element): UUIDPair {
    ...
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("UUIDPair contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
...
export const _encode_UUIDPair = function (value: UUIDPair, elGetter: __utils.ASN1Encoder<UUIDPair>): asn1.ASN1Element {
...
export const _decode_UtmCoordinates = function (el: asn1.ASN1Element): UtmCoordinates {
    ...
    if (sequence.length < 3) {
        throw new asn1.ASN1ConstructionError("UtmCoordinates contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
...
export const _encode_UtmCoordinates = function (value: UtmCoordinates, elGetter: __utils.ASN1Encoder<UtmCoordinates>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
export type CriteriaItem =
    ...
    | asn1.ASN1Element;
export const _decode_CriteriaItem = __utils._decode_extensible_choice<CriteriaItem>({
...
export const _encode_Guide = function (value: Guide, elGetter: __utils.ASN1Encoder<Guide>): asn1.ASN1Element {
    return __utils._encodeSet(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            (value.objectClass ? __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => __utils._encodeObjectIdentifier, __utils.BER)(value.objectClass, __utils.BER) : undefined),
            __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_Criteria, __utils.BER)(value.criteria, __utils.BER)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_EnhancedGuide = function (el: asn1.ASN1Element): EnhancedGuide {
    ...
    let criteria!: Criteria;
    let subset: asn1.OPTIONAL<EnhancedGuide_subset> = oneLevel;
    let _unrecognizedExtensionsList: asn1.ASN1Element[] = [];
...
export const _encode_EnhancedGuide = function (value: EnhancedGuide, elGetter: __utils.ASN1Encoder<EnhancedGuide>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => __utils._encodeObjectIdentifier, __utils.BER)(value.objectClass, __utils.BER),
            __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_Criteria, __utils.BER)(value.criteria, __utils.BER),
            ((value.subset !== undefined && value.subset !== oneLevel) /* TODO: Review this condition. */ ? __utils._encode_explicit(asn1.ASN1TagClass.context, 2, () => _encode_EnhancedGuide_subset, __utils.BER)(value.subset, __utils.BER) : undefined)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export type UnboundedDirectoryString =
    ...
    | { universalString: asn1.UniversalString }
    | { uTF8String: asn1.UTF8String };
export const _decode_UnboundedDirectoryString = __utils._decode_inextensible_choice<UnboundedDirectoryString>({
    "UNIVERSAL 20": [ "teletexString", __utils._decodeTeletexString ],
    "UNIVERSAL 19": [ "printableString", __utils._decodePrintableString ],
    "UNIVERSAL 30": [ "bmpString", __utils._decodeBMPString ],
    "UNIVERSAL 28": [ "universalString", __utils._decodeUniversalString ],
...
export const _encode_UnboundedDirectoryString = __utils._encode_choice<UnboundedDirectoryString>({
    "teletexString": __utils._encodeTeletexString,
    "printableString": __utils._encodePrintableString,
    "bmpString": __utils._encodeBMPString,
    "universalString": __utils._encodeUniversalString,
...
export const _decode_PostalAddress = __utils._decodeSequenceOf<UnboundedDirectoryString>(() => _decode_UnboundedDirectoryString);
export const _encode_PostalAddress = __utils._encodeSequenceOf<UnboundedDirectoryString>(() => _encode_UnboundedDirectoryString, __utils.BER);
...
export const _encode_TelexNumber = function (value: TelexNumber, elGetter: __utils.ASN1Encoder<TelexNumber>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            __utils._encodePrintableString(value.telexNumber, __utils.BER),
            __utils._encodePrintableString(value.countryCode, __utils.BER),
            __utils._encodePrintableString(value.answerback, __utils.BER)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _encode_FacsimileTelephoneNumber = function (value: FacsimileTelephoneNumber, elGetter: __utils.ASN1Encoder<FacsimileTelephoneNumber>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ...
            (value.parameters ? _encode_G3FacsimileNonBasicParameters(value.parameters, __utils.BER) : undefined)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _encode_PresentationAddress = function (value: PresentationAddress, elGetter: __utils.ASN1Encoder<PresentationAddress>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            (value.pSelector ? __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => __utils._encodeOctetString, __utils.BER)(value.pSelector, __utils.BER) : undefined),
            (value.sSelector ? __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => __utils._encodeOctetString, __utils.BER)(value.sSelector, __utils.BER) : undefined),
            (value.tSelector ? __utils._encode_explicit(asn1.ASN1TagClass.context, 2, () => __utils._encodeOctetString, __utils.BER)(value.tSelector, __utils.BER) : undefined),
            __utils._encode_explicit(asn1.ASN1TagClass.context, 3, () => __utils._encodeSetOf<asn1.OCTET_STRING>(() => __utils._encodeOctetString, __utils.BER), __utils.BER)(value.nAddresses, __utils.BER)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _encode_ProtocolInformation = function (value: ProtocolInformation, elGetter: __utils.ASN1Encoder<ProtocolInformation>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ...
            __utils._encodeSetOf<asn1.OBJECT_IDENTIFIER>(() => __utils._encodeObjectIdentifier, __utils.BER)(value.profiles, __utils.BER)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _encode_NameAndOptionalUID = function (value: NameAndOptionalUID, elGetter: __utils.ASN1Encoder<NameAndOptionalUID>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ...
            (value.uid ? _encode_UniqueIdentifier(value.uid, __utils.BER) : undefined)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_UiiFilter = __utils._decode_inextensible_choice<UiiFilter>({
    "CONTEXT 0": [ "item", __utils._decode_explicit<UiiItem>(() => _decode_UiiItem) ],
    "CONTEXT 1": [ "and", __utils._decode_explicit<UiiFilter[]>(() => __utils._decodeSetOf<UiiFilter>(() => _decode_UiiFilter)) ],
    "CONTEXT 2": [ "or", __utils._decode_explicit<UiiFilter[]>(() => __utils._decodeSetOf<UiiFilter>(() => _decode_UiiFilter)) ],
    "CONTEXT 3": [ "not", __utils._decode_explicit<UiiFilter>(() => _decode_UiiFilter) ]
});
export const _encode_UiiFilter = __utils._encode_choice<UiiFilter>({
    "item": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_UiiItem, __utils.BER),
    "and": __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => __utils._encodeSetOf<UiiFilter>(() => _encode_UiiFilter, __utils.BER), __utils.BER),
    "or": __utils._encode_explicit(asn1.ASN1TagClass.context, 2, () => __utils._encodeSetOf<UiiFilter>(() => _encode_UiiFilter, __utils.BER), __utils.BER),
    "not": __utils._encode_explicit(asn1.ASN1TagClass.context, 3, () => _encode_UiiFilter, __utils.BER),
}, __utils.BER);
...
export type UiiFormat_next =
    { length: asn1.INTEGER }
    | { filter: UiiFilter };
export const _decode_UiiFormat_next = __utils._decode_inextensible_choice<UiiFormat_next>({
    "UNIVERSAL 2": [ "length", __utils._decodeInteger ],
    /* NO_TAG_OR_TAG_CLASS */: [ "filter", _decode_UiiFilter ]
});
...
export const _decode_UiiFormat = function (el: asn1.ASN1Element): UiiFormat {
    ...
    let subset: asn1.OPTIONAL<UiiFormat_subset> = baseObject;
    let next!: UiiFormat_next;
    /* END_OF_SEQUENCE_COMPONENT_DECLARATIONS */
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "baseObject": (_el: asn1.ASN1Element): void => { baseObject = _decode_URI(_el); },
        "subset": (_el: asn1.ASN1Element): void => { subset = _decode_UiiFormat_subset(_el); },
        "next": (_el: asn1.ASN1Element): void => { next = _decode_UiiFormat_next(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_UiiFormat = function (value: UiiFormat, elGetter: __utils.ASN1Encoder<UiiFormat>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            (value.baseObject ? _encode_URI(value.baseObject, __utils.BER) : undefined),
            ((value.subset !== undefined && value.subset !== baseObject) /* TODO: Review this condition. */ ? _encode_UiiFormat_subset(value.subset, __utils.BER) : undefined),
...
export const _decode_EpcFormat_fields_Item_charField = __utils._decode_inextensible_choice<EpcFormat_fields_Item_charField>({
    "CONTEXT 0": [ "characters", __utils._decode_explicit<asn1.INTEGER>(() => __utils._decodeInteger) ],
    "CONTEXT 1": [ "maxValue", __utils._decode_explicit<asn1.INTEGER>(() => __utils._decodeInteger) ]
});
export const _encode_EpcFormat_fields_Item_charField = __utils._encode_choice<EpcFormat_fields_Item_charField>({
    "characters": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => __utils._encodeInteger, __utils.BER),
    "maxValue": __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => __utils._encodeInteger, __utils.BER),
}, __utils.BER);
...
export const _decode_EpcFormat_fields_Item = function (el: asn1.ASN1Element): EpcFormat_fields_Item {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "bits": (_el: asn1.ASN1Element): void => { bits = __utils._decodeInteger(_el); },
        "charField": (_el: asn1.ASN1Element): void => { charField = _decode_EpcFormat_fields_Item_charField(_el); },
        "result": (_el: asn1.ASN1Element): void => { result = _decode_EpcFormat_fields_Item_result(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_EpcFormat_fields_Item = function (value: EpcFormat_fields_Item, elGetter: __utils.ASN1Encoder<EpcFormat_fields_Item>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            __utils._encodeInteger(value.bits, __utils.BER),
            _encode_EpcFormat_fields_Item_charField(value.charField, __utils.BER),
            ((value.result !== undefined && value.result !== numericPad) /* TODO: Review this condition. */ ? _encode_EpcFormat_fields_Item_result(value.result, __utils.BER) : undefined)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_EpcFormat = function (el: asn1.ASN1Element): EpcFormat {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "fields": (_el: asn1.ASN1Element): void => { fields = __utils._decodeSequenceOf<EpcFormat_fields_Item>(() => _decode_EpcFormat_fields_Item)(_el); },
        "digitShift": (_el: asn1.ASN1Element): void => { digitShift = __utils._decode_explicit<asn1.INTEGER>(() => __utils._decodeInteger)(_el); },
        "checkCalc": (_el: asn1.ASN1Element): void => { checkCalc = __utils._decode_explicit<asn1.INTEGER>(() => __utils._decodeInteger)(_el); },
        "urnPrefix": (_el: asn1.ASN1Element): void => { urnPrefix = __utils._decodeUTF8String(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_EpcFormat = function (value: EpcFormat, elGetter: __utils.ASN1Encoder<EpcFormat>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            __utils._encodeSequenceOf<EpcFormat_fields_Item>(() => _encode_EpcFormat_fields_Item, __utils.BER)(value.fields, __utils.BER),
            (value.digitShift ? __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => __utils._encodeInteger, __utils.BER)(value.digitShift, __utils.BER) : undefined),
            (value.checkCalc ? __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => __utils._encodeInteger, __utils.BER)(value.checkCalc, __utils.BER) : undefined),
            (value.urnPrefix ? __utils._encodeUTF8String(value.urnPrefix, __utils.BER) : undefined)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _encode_MultipleMatchingLocalities = function (value: MultipleMatchingLocalities, elGetter: __utils.ASN1Encoder<MultipleMatchingLocalities>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            (value.matchingRuleUsed ? __utils._encodeObjectIdentifier(value.matchingRuleUsed, __utils.BER) : undefined),
            __utils._encodeSequenceOf<AttributeValueAssertion>(() => _encode_AttributeValueAssertion, __utils.BER)(value.attributeList, __utils.BER)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_MRMappings = __utils._decodeSequenceOf<MRMapping>(() => _decode_MRMapping);
export const _encode_MRMappings = __utils._encodeSequenceOf<MRMapping>(() => _encode_MRMapping, __utils.BER);
...
export type PwdResponse_warning =
    ...
    | asn1.ASN1Element;
export const _decode_PwdResponse_warning = __utils._decode_extensible_choice<PwdResponse_warning>({
...
export const _encode_PwdResponse_warning = __utils._encode_choice<PwdResponse_warning>({
...
export const _decode_PwdResponse = function (el: asn1.ASN1Element): PwdResponse {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "warning": (_el: asn1.ASN1Element): void => { warning = _decode_PwdResponse_warning(_el); },
        "error": (_el: asn1.ASN1Element): void => { error = _decode_PwdResponse_error(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
    ...
    return new PwdResponse( /* SEQUENCE_CONSTRUCTOR_CALL */
        warning,
        error
    );
};
export const _encode_PwdResponse = function (value: PwdResponse, elGetter: __utils.ASN1Encoder<PwdResponse>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            (value.warning ? _encode_PwdResponse_warning(value.warning, __utils.BER) : undefined),
            (value.error ? _encode_PwdResponse_error(value.error, __utils.BER) : undefined)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_CaseIgnoreList = __utils._decodeSequenceOf<UnboundedDirectoryString>(() => _decode_UnboundedDirectoryString);
export const _encode_CaseIgnoreList = __utils._encodeSequenceOf<UnboundedDirectoryString>(() => _encode_UnboundedDirectoryString, __utils.BER);
...
export const _encode_TimeSpecification_time_absolute = function (value: TimeSpecification_time_absolute, elGetter: __utils.ASN1Encoder<TimeSpecification_time_absolute>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            (value.startTime ? __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => __utils._encodeGeneralizedTime, __utils.BER)(value.startTime, __utils.BER) : undefined),
            (value.endTime ? __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => __utils._encodeGeneralizedTime, __utils.BER)(value.endTime, __utils.BER) : undefined)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _encode_DayTime = function (value: DayTime, elGetter: __utils.ASN1Encoder<DayTime>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => __utils._encodeInteger, __utils.BER)(value.hour, __utils.BER),
            ((value.minute !== undefined && value.minute !== 0) /* TODO: Review this condition. */ ? __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => __utils._encodeInteger, __utils.BER)(value.minute, __utils.BER) : undefined),
            ((value.second !== undefined && value.second !== 0) /* TODO: Review this condition. */ ? __utils._encode_explicit(asn1.ASN1TagClass.context, 2, () => __utils._encodeInteger, __utils.BER)(value.second, __utils.BER) : undefined)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export type Period_days =
    ...
    | { dayOf: XDayOf }
    | asn1.ASN1Element;
export const _decode_Period_days = __utils._decode_extensible_choice<Period_days>({
...
export type Period_weeks =
    ...
    | asn1.ASN1Element;
export const _decode_Period_weeks = __utils._decode_extensible_choice<Period_weeks>({
...
export type Period_months =
    ...
    | asn1.ASN1Element;
export const _decode_Period_months = __utils._decode_extensible_choice<Period_months>({
...
export const _encode_Period = function (value: Period, elGetter: __utils.ASN1Encoder<Period>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            (value.timesOfDay ? __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => __utils._encodeSetOf<DayTimeBand>(() => _encode_DayTimeBand, __utils.BER), __utils.BER)(value.timesOfDay, __utils.BER) : undefined),
            (value.days ? __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_Period_days, __utils.BER)(value.days, __utils.BER) : undefined),
            (value.weeks ? __utils._encode_explicit(asn1.ASN1TagClass.context, 2, () => _encode_Period_weeks, __utils.BER)(value.weeks, __utils.BER) : undefined),
            (value.months ? __utils._encode_explicit(asn1.ASN1TagClass.context, 3, () => _encode_Period_months, __utils.BER)(value.months, __utils.BER) : undefined),
            (value.years ? __utils._encode_explicit(asn1.ASN1TagClass.context, 4, () => __utils._encodeSetOf<asn1.INTEGER>(() => __utils._encodeInteger, __utils.BER), __utils.BER)(value.years, __utils.BER) : undefined)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _encode_TimeSpecification = function (value: TimeSpecification, elGetter: __utils.ASN1Encoder<TimeSpecification>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ...
            ((value.notThisTime !== undefined && value.notThisTime !== false) /* TODO: Review this condition. */ ? __utils._encodeBoolean(value.notThisTime, __utils.BER) : undefined),
            (value.timeZone ? _encode_TimeZone(value.timeZone, __utils.BER) : undefined)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _encode_TimeAssertion_between = function (value: TimeAssertion_between, elGetter: __utils.ASN1Encoder<TimeAssertion_between>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => __utils._encodeGeneralizedTime, __utils.BER)(value.startTime, __utils.BER),
            (value.endTime ? __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => __utils._encodeGeneralizedTime, __utils.BER)(value.endTime, __utils.BER) : undefined),
            ((value.entirely !== undefined && value.entirely !== false) /* TODO: Review this condition. */ ? __utils._encodeBoolean(value.entirely, __utils.BER) : undefined)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export type TimeAssertion =
    ...
    | asn1.ASN1Element;
export const _decode_TimeAssertion = __utils._decode_extensible_choice<TimeAssertion>({
...
export type LocaleContextSyntax =
    ...
    | asn1.ASN1Element;
export const _decode_LocaleContextSyntax = __utils._decode_extensible_choice<LocaleContextSyntax>({
    "UNIVERSAL 6": [ "localeID1", __utils._decodeObjectIdentifier ],
    /* NO_TAG_OR_TAG_CLASS */: [ "localeID2", _decode_UnboundedDirectoryString ]
});
...
export const _decode_AttributeOptionList = __utils._decodeSequenceOf<asn1.UTF8String>(() => __utils._decodeUTF8String);
export const _encode_AttributeOptionList = __utils._encodeSequenceOf<asn1.UTF8String>(() => __utils._encodeUTF8String, __utils.BER);
