...
export const _decode_HierarchicalAgreement = function (el: asn1.ASN1Element): HierarchicalAgreement {
    ...
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("HierarchicalAgreement contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "rdn";
    ...
    rdn = __utils._decode_explicit<RelativeDistinguishedName>(() => _decode_RelativeDistinguishedName)(sequence[0]);
    immediateSuperior = __utils._decode_explicit<DistinguishedName>(() => _decode_DistinguishedName)(sequence[1]);
...
export const _encode_HierarchicalAgreement = function (value: HierarchicalAgreement, elGetter: __utils.ASN1Encoder<HierarchicalAgreement>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_RelativeDistinguishedName, __utils.BER)(value.rdn, __utils.BER),
            __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_DistinguishedName, __utils.BER)(value.immediateSuperior, __utils.BER)
        ],
...
export const _decode_SubentryInfo = function (el: asn1.ASN1Element): SubentryInfo {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("SubentryInfo contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "rdn";
    ...
    let info!: Attribute[];
    rdn = __utils._decode_explicit<RelativeDistinguishedName>(() => _decode_RelativeDistinguishedName)(sequence[0]);
    info = __utils._decode_explicit<Attribute[]>(() => __utils._decodeSetOf<Attribute>(() => _decode_Attribute))(sequence[1]);
    // TODO: Validate values.
...
export const _encode_SubentryInfo = function (value: SubentryInfo, elGetter: __utils.ASN1Encoder<SubentryInfo>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_RelativeDistinguishedName, __utils.BER)(value.rdn, __utils.BER),
            __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => __utils._encodeSetOf<Attribute>(() => _encode_Attribute, __utils.BER), __utils.BER)(value.info, __utils.BER)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_SubordinateToSuperior = function (el: asn1.ASN1Element): SubordinateToSuperior {
    ...
    const callbacks: __utils.DecodingMap = {
        "accessPoints": (_el: asn1.ASN1Element): void => { accessPoints = __utils._decode_explicit<MasterAndShadowAccessPoints>(() => _decode_MasterAndShadowAccessPoints)(_el); },
        "alias": (_el: asn1.ASN1Element): void => { alias = __utils._decode_explicit<asn1.BOOLEAN>(() => __utils._decodeBoolean)(_el); },
        "entryInfo": (_el: asn1.ASN1Element): void => { entryInfo = __utils._decode_explicit<Attribute[]>(() => __utils._decodeSetOf<Attribute>(() => _decode_Attribute))(_el); },
        "subentries": (_el: asn1.ASN1Element): void => { subentries = __utils._decode_explicit<SubentryInfo[]>(() => __utils._decodeSetOf<SubentryInfo>(() => _decode_SubentryInfo))(_el); }
    };
...
export const _encode_SubordinateToSuperior = function (value: SubordinateToSuperior, elGetter: __utils.ASN1Encoder<SubordinateToSuperior>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            (value.accessPoints ? __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_MasterAndShadowAccessPoints, __utils.BER)(value.accessPoints, __utils.BER) : undefined),
            ((value.alias !== undefined && value.alias !== false) /* TODO: Review this condition. */ ? __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => __utils._encodeBoolean, __utils.BER)(value.alias, __utils.BER) : undefined),
            (value.entryInfo ? __utils._encode_explicit(asn1.ASN1TagClass.context, 2, () => __utils._encodeSetOf<Attribute>(() => _encode_Attribute, __utils.BER), __utils.BER)(value.entryInfo, __utils.BER) : undefined),
            (value.subentries ? __utils._encode_explicit(asn1.ASN1TagClass.context, 3, () => __utils._encodeSetOf<SubentryInfo>(() => _encode_SubentryInfo, __utils.BER), __utils.BER)(value.subentries, __utils.BER) : undefined)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_Vertex = function (el: asn1.ASN1Element): Vertex {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "rdn": (_el: asn1.ASN1Element): void => { rdn = __utils._decode_explicit<RelativeDistinguishedName>(() => _decode_RelativeDistinguishedName)(_el); },
        "admPointInfo": (_el: asn1.ASN1Element): void => { admPointInfo = __utils._decode_explicit<Attribute[]>(() => __utils._decodeSetOf<Attribute>(() => _decode_Attribute))(_el); },
        "subentries": (_el: asn1.ASN1Element): void => { subentries = __utils._decode_explicit<SubentryInfo[]>(() => __utils._decodeSetOf<SubentryInfo>(() => _decode_SubentryInfo))(_el); },
        "accessPoints": (_el: asn1.ASN1Element): void => { accessPoints = __utils._decode_explicit<MasterAndShadowAccessPoints>(() => _decode_MasterAndShadowAccessPoints)(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
...
export const _encode_Vertex = function (value: Vertex, elGetter: __utils.ASN1Encoder<Vertex>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_RelativeDistinguishedName, __utils.BER)(value.rdn, __utils.BER),
            (value.admPointInfo ? __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => __utils._encodeSetOf<Attribute>(() => _encode_Attribute, __utils.BER), __utils.BER)(value.admPointInfo, __utils.BER) : undefined),
            (value.subentries ? __utils._encode_explicit(asn1.ASN1TagClass.context, 2, () => __utils._encodeSetOf<SubentryInfo>(() => _encode_SubentryInfo, __utils.BER), __utils.BER)(value.subentries, __utils.BER) : undefined),
            (value.accessPoints ? __utils._encode_explicit(asn1.ASN1TagClass.context, 3, () => _encode_MasterAndShadowAccessPoints, __utils.BER)(value.accessPoints, __utils.BER) : undefined)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_DITcontext = __utils._decodeSequenceOf<Vertex>(() => _decode_Vertex);
export const _encode_DITcontext = __utils._encodeSequenceOf<Vertex>(() => _encode_Vertex, __utils.BER);
...
export const _decode_SuperiorToSubordinate = function (el: asn1.ASN1Element): SuperiorToSubordinate {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "contextPrefixInfo": (_el: asn1.ASN1Element): void => { contextPrefixInfo = __utils._decode_explicit<DITcontext>(() => _decode_DITcontext)(_el); },
        "entryInfo": (_el: asn1.ASN1Element): void => { entryInfo = __utils._decode_explicit<Attribute[]>(() => __utils._decodeSetOf<Attribute>(() => _decode_Attribute))(_el); },
        "immediateSuperiorInfo": (_el: asn1.ASN1Element): void => { immediateSuperiorInfo = __utils._decode_explicit<Attribute[]>(() => __utils._decodeSetOf<Attribute>(() => _decode_Attribute))(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_SuperiorToSubordinate = function (value: SuperiorToSubordinate, elGetter: __utils.ASN1Encoder<SuperiorToSubordinate>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_DITcontext, __utils.BER)(value.contextPrefixInfo, __utils.BER),
            (value.entryInfo ? __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => __utils._encodeSetOf<Attribute>(() => _encode_Attribute, __utils.BER), __utils.BER)(value.entryInfo, __utils.BER) : undefined),
            (value.immediateSuperiorInfo ? __utils._encode_explicit(asn1.ASN1TagClass.context, 2, () => __utils._encodeSetOf<Attribute>(() => _encode_Attribute, __utils.BER), __utils.BER)(value.immediateSuperiorInfo, __utils.BER) : undefined)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_NonSpecificHierarchicalAgreement = function (el: asn1.ASN1Element): NonSpecificHierarchicalAgreement {
    ...
    if (sequence.length < 1) {
        throw new asn1.ASN1ConstructionError("NonSpecificHierarchicalAgreement contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "immediateSuperior";
    let immediateSuperior!: DistinguishedName;
    immediateSuperior = __utils._decode_explicit<DistinguishedName>(() => _decode_DistinguishedName)(sequence[0]);
    // TODO: Validate values.
...
export const _encode_NonSpecificHierarchicalAgreement = function (value: NonSpecificHierarchicalAgreement, elGetter: __utils.ASN1Encoder<NonSpecificHierarchicalAgreement>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_DistinguishedName, __utils.BER)(value.immediateSuperior, __utils.BER)
        ],
...
export const _encode_NHOBSubordinateToSuperior = function (value: NHOBSubordinateToSuperior, elGetter: __utils.ASN1Encoder<NHOBSubordinateToSuperior>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            (value.accessPoints ? __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_MasterAndShadowAccessPoints, __utils.BER)(value.accessPoints, __utils.BER) : undefined),
            (value.subentries ? __utils._encode_explicit(asn1.ASN1TagClass.context, 3, () => __utils._encodeSetOf<SubentryInfo>(() => _encode_SubentryInfo, __utils.BER), __utils.BER)(value.subentries, __utils.BER) : undefined)
