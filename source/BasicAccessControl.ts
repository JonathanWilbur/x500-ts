...
export const _decode_AuthenticationLevel_basicLevels_level = __utils._decodeEnumerated;
export const _encode_AuthenticationLevel_basicLevels_level = __utils._encodeEnumerated;
...
export const _decode_AuthenticationLevel_basicLevels = function (el: asn1.ASN1Element): AuthenticationLevel_basicLevels {
    ...
    const callbacks: __utils.DecodingMap = {
        "level": (_el: asn1.ASN1Element): void => { level = _decode_AuthenticationLevel_basicLevels_level(_el); },
        "localQualifier": (_el: asn1.ASN1Element): void => { localQualifier = __utils._decodeInteger(_el); },
        "signed": (_el: asn1.ASN1Element): void => { signed = __utils._decodeBoolean(_el); }
    };
...
export const _encode_AuthenticationLevel_basicLevels = function (value: AuthenticationLevel_basicLevels, elGetter: __utils.ASN1Encoder<AuthenticationLevel_basicLevels>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            _encode_AuthenticationLevel_basicLevels_level(value.level, __utils.BER),
            (value.localQualifier ? __utils._encodeInteger(value.localQualifier, __utils.BER) : undefined),
            ((value.signed !== undefined && value.signed !== false) /* TODO: Review this condition. */ ? __utils._encodeBoolean(value.signed, __utils.BER) : undefined)
        ],
...
export type AuthenticationLevel =
    ...
    | { other: asn1.EXTERNAL }
    | asn1.ASN1Element;
export const _decode_AuthenticationLevel = __utils._decode_extensible_choice<AuthenticationLevel>({
    "UNIVERSAL 16": [ "basicLevels", _decode_AuthenticationLevel_basicLevels ],
    "UNIVERSAL 8": [ "other", __utils._decodeExternal ]
});
export const _encode_AuthenticationLevel = __utils._encode_choice<AuthenticationLevel>({
...
export const _decode_MaxValueCount = function (el: asn1.ASN1Element): MaxValueCount {
    ...
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("MaxValueCount contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
...
export const _encode_MaxValueCount = function (value: MaxValueCount, elGetter: __utils.ASN1Encoder<MaxValueCount>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
export const _decode_RestrictedValue = function (el: asn1.ASN1Element): RestrictedValue {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("RestrictedValue contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "type";
...
export const _encode_RestrictedValue = function (value: RestrictedValue, elGetter: __utils.ASN1Encoder<RestrictedValue>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            _encode_AttributeType(value.type_, __utils.BER),
...
export const _root_component_type_list_1_spec_for_ProtectedItems: __utils.ComponentSpec[] = [
    ...
    new __utils.ComponentSpec("allAttributeValues", true, __utils.hasTag(asn1.ASN1TagClass.context, 3), undefined, undefined),
    new __utils.ComponentSpec("allUserAttributeTypesAndValues", true, __utils.hasTag(asn1.ASN1TagClass.context, 4), undefined, undefined),
    new __utils.ComponentSpec("attributeValue", true, __utils.hasTag(asn1.ASN1TagClass.context, 5), undefined, undefined),
    new __utils.ComponentSpec("selfValue", true, __utils.hasTag(asn1.ASN1TagClass.context, 6), undefined, undefined),
    new __utils.ComponentSpec("rangeOfValues", true, __utils.hasTag(asn1.ASN1TagClass.context, 7), undefined, undefined),
    new __utils.ComponentSpec("maxValueCount", true, __utils.hasTag(asn1.ASN1TagClass.context, 8), undefined, undefined),
    new __utils.ComponentSpec("maxImmSub", true, __utils.hasTag(asn1.ASN1TagClass.context, 9), undefined, undefined),
    new __utils.ComponentSpec("restrictedBy", true, __utils.hasTag(asn1.ASN1TagClass.context, 10), undefined, undefined),
...
export const _decode_ProtectedItems = function (el: asn1.ASN1Element): ProtectedItems {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "entry": (_el: asn1.ASN1Element): void => { entry = __utils._decode_explicit<asn1.NULL>(() => __utils._decodeNull)(_el); },
        "allUserAttributeTypes": (_el: asn1.ASN1Element): void => { allUserAttributeTypes = __utils._decode_explicit<asn1.NULL>(() => __utils._decodeNull)(_el); },
        "attributeType": (_el: asn1.ASN1Element): void => { attributeType = __utils._decode_explicit<AttributeType[]>(() => __utils._decodeSetOf<AttributeType>(() => _decode_AttributeType))(_el); },
        "allAttributeValues": (_el: asn1.ASN1Element): void => { allAttributeValues = __utils._decode_explicit<AttributeType[]>(() => __utils._decodeSetOf<AttributeType>(() => _decode_AttributeType))(_el); },
        "allUserAttributeTypesAndValues": (_el: asn1.ASN1Element): void => { allUserAttributeTypesAndValues = __utils._decode_explicit<asn1.NULL>(() => __utils._decodeNull)(_el); },
        "attributeValue": (_el: asn1.ASN1Element): void => { attributeValue = __utils._decode_explicit<AttributeTypeAndValue[]>(() => __utils._decodeSetOf<AttributeTypeAndValue>(() => _decode_AttributeTypeAndValue))(_el); },
        "selfValue": (_el: asn1.ASN1Element): void => { selfValue = __utils._decode_explicit<AttributeType[]>(() => __utils._decodeSetOf<AttributeType>(() => _decode_AttributeType))(_el); },
        "rangeOfValues": (_el: asn1.ASN1Element): void => { rangeOfValues = __utils._decode_explicit<Filter>(() => _decode_Filter)(_el); },
        "maxValueCount": (_el: asn1.ASN1Element): void => { maxValueCount = __utils._decode_explicit<MaxValueCount[]>(() => __utils._decodeSetOf<MaxValueCount>(() => _decode_MaxValueCount))(_el); },
        "maxImmSub": (_el: asn1.ASN1Element): void => { maxImmSub = __utils._decode_explicit<asn1.INTEGER>(() => __utils._decodeInteger)(_el); },
        "restrictedBy": (_el: asn1.ASN1Element): void => { restrictedBy = __utils._decode_explicit<RestrictedValue[]>(() => __utils._decodeSetOf<RestrictedValue>(() => _decode_RestrictedValue))(_el); },
        "contexts": (_el: asn1.ASN1Element): void => { contexts = __utils._decode_explicit<ContextAssertion[]>(() => __utils._decodeSetOf<ContextAssertion>(() => _decode_ContextAssertion))(_el); },
        "classes": (_el: asn1.ASN1Element): void => { classes = __utils._decode_explicit<Refinement>(() => _decode_Refinement)(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_ProtectedItems = function (value: ProtectedItems, elGetter: __utils.ASN1Encoder<ProtectedItems>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            (value.entry ? __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => __utils._encodeNull, __utils.BER)(value.entry, __utils.BER) : undefined),
            (value.allUserAttributeTypes ? __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => __utils._encodeNull, __utils.BER)(value.allUserAttributeTypes, __utils.BER) : undefined),
            (value.attributeType ? __utils._encode_explicit(asn1.ASN1TagClass.context, 2, () => __utils._encodeSetOf<AttributeType>(() => _encode_AttributeType, __utils.BER), __utils.BER)(value.attributeType, __utils.BER) : undefined),
            (value.allAttributeValues ? __utils._encode_explicit(asn1.ASN1TagClass.context, 3, () => __utils._encodeSetOf<AttributeType>(() => _encode_AttributeType, __utils.BER), __utils.BER)(value.allAttributeValues, __utils.BER) : undefined),
            (value.allUserAttributeTypesAndValues ? __utils._encode_explicit(asn1.ASN1TagClass.context, 4, () => __utils._encodeNull, __utils.BER)(value.allUserAttributeTypesAndValues, __utils.BER) : undefined),
            (value.attributeValue ? __utils._encode_explicit(asn1.ASN1TagClass.context, 5, () => __utils._encodeSetOf<AttributeTypeAndValue>(() => _encode_AttributeTypeAndValue, __utils.BER), __utils.BER)(value.attributeValue, __utils.BER) : undefined),
            (value.selfValue ? __utils._encode_explicit(asn1.ASN1TagClass.context, 6, () => __utils._encodeSetOf<AttributeType>(() => _encode_AttributeType, __utils.BER), __utils.BER)(value.selfValue, __utils.BER) : undefined),
            (value.rangeOfValues ? __utils._encode_explicit(asn1.ASN1TagClass.context, 7, () => _encode_Filter, __utils.BER)(value.rangeOfValues, __utils.BER) : undefined),
            (value.maxValueCount ? __utils._encode_explicit(asn1.ASN1TagClass.context, 8, () => __utils._encodeSetOf<MaxValueCount>(() => _encode_MaxValueCount, __utils.BER), __utils.BER)(value.maxValueCount, __utils.BER) : undefined),
            (value.maxImmSub ? __utils._encode_explicit(asn1.ASN1TagClass.context, 9, () => __utils._encodeInteger, __utils.BER)(value.maxImmSub, __utils.BER) : undefined),
            (value.restrictedBy ? __utils._encode_explicit(asn1.ASN1TagClass.context, 10, () => __utils._encodeSetOf<RestrictedValue>(() => _encode_RestrictedValue, __utils.BER), __utils.BER)(value.restrictedBy, __utils.BER) : undefined),
            (value.contexts ? __utils._encode_explicit(asn1.ASN1TagClass.context, 11, () => __utils._encodeSetOf<ContextAssertion>(() => _encode_ContextAssertion, __utils.BER), __utils.BER)(value.contexts, __utils.BER) : undefined),
            (value.classes ? __utils._encode_explicit(asn1.ASN1TagClass.context, 12, () => _encode_Refinement, __utils.BER)(value.classes, __utils.BER) : undefined)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_UserClasses = function (el: asn1.ASN1Element): UserClasses {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "allUsers": (_el: asn1.ASN1Element): void => { allUsers = __utils._decode_explicit<asn1.NULL>(() => __utils._decodeNull)(_el); },
        "thisEntry": (_el: asn1.ASN1Element): void => { thisEntry = __utils._decode_explicit<asn1.NULL>(() => __utils._decodeNull)(_el); },
        "name": (_el: asn1.ASN1Element): void => { name = __utils._decode_explicit<NameAndOptionalUID[]>(() => __utils._decodeSetOf<NameAndOptionalUID>(() => _decode_NameAndOptionalUID))(_el); },
        "userGroup": (_el: asn1.ASN1Element): void => { userGroup = __utils._decode_explicit<NameAndOptionalUID[]>(() => __utils._decodeSetOf<NameAndOptionalUID>(() => _decode_NameAndOptionalUID))(_el); },
        "subtree": (_el: asn1.ASN1Element): void => { subtree = __utils._decode_explicit<SubtreeSpecification[]>(() => __utils._decodeSetOf<SubtreeSpecification>(() => _decode_SubtreeSpecification))(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_UserClasses = function (value: UserClasses, elGetter: __utils.ASN1Encoder<UserClasses>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            (value.allUsers ? __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => __utils._encodeNull, __utils.BER)(value.allUsers, __utils.BER) : undefined),
            (value.thisEntry ? __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => __utils._encodeNull, __utils.BER)(value.thisEntry, __utils.BER) : undefined),
            (value.name ? __utils._encode_explicit(asn1.ASN1TagClass.context, 2, () => __utils._encodeSetOf<NameAndOptionalUID>(() => _encode_NameAndOptionalUID, __utils.BER), __utils.BER)(value.name, __utils.BER) : undefined),
            (value.userGroup ? __utils._encode_explicit(asn1.ASN1TagClass.context, 3, () => __utils._encodeSetOf<NameAndOptionalUID>(() => _encode_NameAndOptionalUID, __utils.BER), __utils.BER)(value.userGroup, __utils.BER) : undefined),
            (value.subtree ? __utils._encode_explicit(asn1.ASN1TagClass.context, 4, () => __utils._encodeSetOf<SubtreeSpecification>(() => _encode_SubtreeSpecification, __utils.BER), __utils.BER)(value.subtree, __utils.BER) : undefined)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_ItemPermission = function (el: asn1.ASN1Element): ItemPermission {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "precedence": (_el: asn1.ASN1Element): void => { precedence = _decode_Precedence(_el); },
        "userClasses": (_el: asn1.ASN1Element): void => { userClasses = _decode_UserClasses(_el); },
        "grantsAndDenials": (_el: asn1.ASN1Element): void => { grantsAndDenials = _decode_GrantsAndDenials(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_ItemPermission = function (value: ItemPermission, elGetter: __utils.ASN1Encoder<ItemPermission>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            (value.precedence ? _encode_Precedence(value.precedence, __utils.BER) : undefined),
            _encode_UserClasses(value.userClasses, __utils.BER),
            _encode_GrantsAndDenials(value.grantsAndDenials, __utils.BER)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_ACIItem_itemOrUserFirst_itemFirst = function (el: asn1.ASN1Element): ACIItem_itemOrUserFirst_itemFirst {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("ACIItem-itemOrUserFirst-itemFirst contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    ...
    itemPermissions = __utils._decodeSetOf<ItemPermission>(() => _decode_ItemPermission)(sequence[1]);
    // TODO: Validate values.
...
export const _encode_ACIItem_itemOrUserFirst_itemFirst = function (value: ACIItem_itemOrUserFirst_itemFirst, elGetter: __utils.ASN1Encoder<ACIItem_itemOrUserFirst_itemFirst>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            _encode_ProtectedItems(value.protectedItems, __utils.BER),
            __utils._encodeSetOf<ItemPermission>(() => _encode_ItemPermission, __utils.BER)(value.itemPermissions, __utils.BER)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_UserPermission = function (el: asn1.ASN1Element): UserPermission {
    ...
    const callbacks: __utils.DecodingMap = {
        "precedence": (_el: asn1.ASN1Element): void => { precedence = _decode_Precedence(_el); },
        "protectedItems": (_el: asn1.ASN1Element): void => { protectedItems = _decode_ProtectedItems(_el); },
        "grantsAndDenials": (_el: asn1.ASN1Element): void => { grantsAndDenials = _decode_GrantsAndDenials(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_UserPermission = function (value: UserPermission, elGetter: __utils.ASN1Encoder<UserPermission>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            (value.precedence ? _encode_Precedence(value.precedence, __utils.BER) : undefined),
            _encode_ProtectedItems(value.protectedItems, __utils.BER),
...
export const _decode_ACIItem_itemOrUserFirst_userFirst = function (el: asn1.ASN1Element): ACIItem_itemOrUserFirst_userFirst {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("ACIItem-itemOrUserFirst-userFirst contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    ...
    userPermissions = __utils._decodeSetOf<UserPermission>(() => _decode_UserPermission)(sequence[1]);
    // TODO: Validate values.
...
export const _encode_ACIItem_itemOrUserFirst_userFirst = function (value: ACIItem_itemOrUserFirst_userFirst, elGetter: __utils.ASN1Encoder<ACIItem_itemOrUserFirst_userFirst>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            _encode_UserClasses(value.userClasses, __utils.BER),
            __utils._encodeSetOf<UserPermission>(() => _encode_UserPermission, __utils.BER)(value.userPermissions, __utils.BER)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export type ACIItem_itemOrUserFirst =
    ...
    | asn1.ASN1Element;
export const _decode_ACIItem_itemOrUserFirst = __utils._decode_extensible_choice<ACIItem_itemOrUserFirst>({
    "CONTEXT 0": [ "itemFirst", __utils._decode_explicit<ACIItem_itemOrUserFirst_itemFirst>(() => _decode_ACIItem_itemOrUserFirst_itemFirst) ],
    "CONTEXT 1": [ "userFirst", __utils._decode_explicit<ACIItem_itemOrUserFirst_userFirst>(() => _decode_ACIItem_itemOrUserFirst_userFirst) ]
});
export const _encode_ACIItem_itemOrUserFirst = __utils._encode_choice<ACIItem_itemOrUserFirst>({
    "itemFirst": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_ACIItem_itemOrUserFirst_itemFirst, __utils.BER),
    "userFirst": __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_ACIItem_itemOrUserFirst_userFirst, __utils.BER),
}, __utils.BER);
...
export const _decode_ACIItem = function (el: asn1.ASN1Element): ACIItem {
    ...
    if (sequence.length < 4) {
        throw new asn1.ASN1ConstructionError("ACIItem contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
...
export const _encode_ACIItem = function (value: ACIItem, elGetter: __utils.ASN1Encoder<ACIItem>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            _encode_UnboundedDirectoryString(value.identificationTag, __utils.BER),
            _encode_Precedence(value.precedence, __utils.BER),
            _encode_AuthenticationLevel(value.authenticationLevel, __utils.BER),
            _encode_ACIItem_itemOrUserFirst(value.itemOrUserFirst, __utils.BER)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
