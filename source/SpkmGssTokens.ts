...
export type Conf_Algs = { algs: AlgorithmIdentifier[] } | { null_: asn1.NULL };
...
export const _decode_Intg_Algs = __utils._decodeSequenceOf<AlgorithmIdentifier>(
    () => _decode_AlgorithmIdentifier
);
export const _encode_Intg_Algs = __utils._encodeSequenceOf<AlgorithmIdentifier>(
    () => _encode_AlgorithmIdentifier,
    __utils.BER
);

export type OWF_Algs = AlgorithmIdentifier[]; // SequenceOfType
export const _decode_OWF_Algs = __utils._decodeSequenceOf<AlgorithmIdentifier>(
    () => _decode_AlgorithmIdentifier
);
export const _encode_OWF_Algs = __utils._encodeSequenceOf<AlgorithmIdentifier>(
    () => _encode_AlgorithmIdentifier,
    __utils.BER
);
...
export const _encode_Context_Data = function (
    value: Context_Data,
...
export const _decode_Key_Estb_Algs = __utils._decodeSequenceOf<
    AlgorithmIdentifier
>(() => _decode_AlgorithmIdentifier);
export const _encode_Key_Estb_Algs = __utils._encodeSequenceOf<
    AlgorithmIdentifier
...
export const _decode_Req_contents = function (
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "src-name": (_el: asn1.ASN1Element): void => {
            src_name = __utils._decode_implicit<Name>(() => _decode_Name)(_el);
        },
...
export const _encode_Req_contents = function (
    value: Req_contents,
...
export const _encode_REQ_TOKEN = function (
    value: REQ_TOKEN,
...
export const _decode_CertificationPath = function (
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        theCACertificates: (_el: asn1.ASN1Element): void => {
            theCACertificates = __utils._decode_implicit<CertificatePair[]>(
                () =>
...
export const _decode_CertificationData = function (
    ...
    const callbacks: __utils.DecodingMap = {
        certificationPath: (_el: asn1.ASN1Element): void => {
            certificationPath = __utils._decode_implicit<CertificationPath>(
...
export const _encode_CertificationData = function (
...
export const _encode_AuthorizationData_Item = function (
...
export const _decode_AuthorizationData = __utils._decodeSequenceOf<
    AuthorizationData_Item
>(() => _decode_AuthorizationData_Item);
export const _encode_AuthorizationData = __utils._encodeSequenceOf<
    AuthorizationData_Item
...
export const _encode_SPKM_REQ = function (
    value: SPKM_REQ,
...
export const _encode_Rep_ti_contents = function (
...
export const _encode_REP_TI_TOKEN = function (
    value: REP_TI_TOKEN,
...
export const _encode_SPKM_REP_TI = function (
    value: SPKM_REP_TI,
...
export const _encode_REP_IT_TOKEN = function (
    value: REP_IT_TOKEN,
...
export const _encode_SPKM_REP_IT = function (
    value: SPKM_REP_IT,
...
export const _encode_ERROR_TOKEN = function (
    value: ERROR_TOKEN,
...
export const _encode_SPKM_ERROR = function (
    value: SPKM_ERROR,
...
export const _decode_SeqNum = function (el: asn1.ASN1Element): SeqNum {
    ...
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError(
            "SeqNum contained only " + sequence.length.toString() + " elements."
        );
    }
    // TODO: Validate tags.
    sequence[0].name = "num";
...
export const _encode_SeqNum = function (
    value: SeqNum,
...
export const _decode_Mic_Header = function (el: asn1.ASN1Element): Mic_Header {
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "snd-seq": (_el: asn1.ASN1Element): void => {
            snd_seq = __utils._decode_implicit<SeqNum>(() => _decode_SeqNum)(
                _el
            );
        },
    };
...
export const _encode_Mic_Header = function (
    value: Mic_Header,
...
export const _encode_SPKM_MIC = function (
    value: SPKM_MIC,
...
export type Conf_Alg = { algId: AlgorithmIdentifier } | { null_: asn1.NULL };
...
export const _encode_Wrap_Header = function (
    value: Wrap_Header,
...
export const _encode_Wrap_Body = function (
    value: Wrap_Body,
...
export const _encode_SPKM_WRAP = function (
    value: SPKM_WRAP,
...
export const _encode_Del_Header = function (
    value: Del_Header,
...
export const _encode_SPKM_DEL = function (
    value: SPKM_DEL,
...
export type SPKMInnerContextToken =
    ...
    | { wrap: SPKM_WRAP }
    | { del: SPKM_DEL };
export const _decode_SPKMInnerContextToken = __utils._decode_inextensible_choice<
...
>({
    ...
    "CONTEXT 1": [
        "rep_ti",
        __utils._decode_implicit<SPKM_REP_TI>(() => _decode_SPKM_REP_TI),
    ],
    "CONTEXT 2": [
        "rep_it",
        __utils._decode_implicit<SPKM_REP_IT>(() => _decode_SPKM_REP_IT),
    ],
    "CONTEXT 3": [
        "error",
...
export const _encode_SPKMInnerContextToken = __utils._encode_choice<
    SPKMInnerContextToken
>(
    {
...
export const _encode_InitialContextToken = __utils._encode_implicit(
