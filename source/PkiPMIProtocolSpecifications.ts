...
export const _decode_AVMPcommonComponents = function (el: asn1.ASN1Element): AVMPcommonComponents {
    ...
    const callbacks: __utils.DecodingMap = {
        "version": (_el: asn1.ASN1Element): void => { version = _decode_AVMPversion(_el); },
        "timeStamp": (_el: asn1.ASN1Element): void => { timeStamp = __utils._decodeGeneralizedTime(_el); },
        "sequence": (_el: asn1.ASN1Element): void => { sequence = _decode_AVMPsequence(_el); }
    };
...
export const _encode_AVMPcommonComponents = function (value: AVMPcommonComponents, elGetter: __utils.ASN1Encoder<AVMPcommonComponents>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ((value.version !== undefined && value.version !== v1) /* TODO: Review this condition. */ ? _encode_AVMPversion(value.version, __utils.BER) : undefined),
            __utils._encodeGeneralizedTime(value.timeStamp, __utils.BER),
...
export const _encode_CertReq = function (value: CertReq, elGetter: __utils.ASN1Encoder<CertReq>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ((value.version !== undefined && value.version !== v1) /* TODO: Review this condition. */ ? _encode_AVMPversion(value.version, __utils.BER) : undefined),
            __utils._encodeGeneralizedTime(value.timeStamp, __utils.BER),
...
export const _decode_CertOK = function (el: asn1.ASN1Element): CertOK {
    ...
    if (sequence.length < 1) {
        throw new asn1.ASN1ConstructionError("CertOK contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
...
export const _encode_CertOK = function (value: CertOK, elGetter: __utils.ASN1Encoder<CertOK>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
export type CertErr_notOK =
    ...
    | { avmpErr: AVMP_error }
    | asn1.ASN1Element;
export const _decode_CertErr_notOK = __utils._decode_extensible_choice<CertErr_notOK>({
    "CONTEXT 0": [ "wrErr", __utils._decode_explicit<PkiWaError>(() => _decode_PkiWaError) ],
    "CONTEXT 1": [ "avmpErr", __utils._decode_explicit<AVMP_error>(() => _decode_AVMP_error) ]
});
export const _encode_CertErr_notOK = __utils._encode_choice<CertErr_notOK>({
    "wrErr": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_PkiWaError, __utils.BER),
    "avmpErr": __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_AVMP_error, __utils.BER),
}, __utils.BER);


export type Notifications = Attribute[]; // SequenceOfType
export const _decode_Notifications = __utils._decodeSequenceOf<Attribute>(() => _decode_Attribute);
export const _encode_Notifications = __utils._encodeSequenceOf<Attribute>(() => _encode_Attribute, __utils.BER);
...
export const _decode_CertErr = function (el: asn1.ASN1Element): CertErr {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "notOK": (_el: asn1.ASN1Element): void => { notOK = _decode_CertErr_notOK(_el); },
        "note": (_el: asn1.ASN1Element): void => { note = _decode_Notifications(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_CertErr = function (value: CertErr, elGetter: __utils.ASN1Encoder<CertErr>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            _encode_CertErr_notOK(value.notOK, __utils.BER),
            (value.note ? _encode_Notifications(value.note, __utils.BER) : undefined)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export type CertRsp_result =
    ...
    | { failure: CertErr }
    | asn1.ASN1Element;
export const _decode_CertRsp_result = __utils._decode_extensible_choice<CertRsp_result>({
    "CONTEXT 0": [ "success", __utils._decode_explicit<CertOK>(() => _decode_CertOK) ],
    "CONTEXT 1": [ "failure", __utils._decode_explicit<CertErr>(() => _decode_CertErr) ]
});
export const _encode_CertRsp_result = __utils._encode_choice<CertRsp_result>({
    "success": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_CertOK, __utils.BER),
    "failure": __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_CertErr, __utils.BER),
}, __utils.BER);
...
export const _decode_CertRsp = function (el: asn1.ASN1Element): CertRsp {
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "timeStamp": (_el: asn1.ASN1Element): void => { timeStamp = __utils._decodeGeneralizedTime(_el); },
        "sequence": (_el: asn1.ASN1Element): void => { sequence = _decode_AVMPsequence(_el); },
        "result": (_el: asn1.ASN1Element): void => { result = _decode_CertRsp_result(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_CertRsp = function (value: CertRsp, elGetter: __utils.ASN1Encoder<CertRsp>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ((value.version !== undefined && value.version !== v1) /* TODO: Review this condition. */ ? _encode_AVMPversion(value.version, __utils.BER) : undefined),
            __utils._encodeGeneralizedTime(value.timeStamp, __utils.BER),
...
export const _decode_AddAvlReq = function (el: asn1.ASN1Element): AddAvlReq {
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "timeStamp": (_el: asn1.ASN1Element): void => { timeStamp = __utils._decodeGeneralizedTime(_el); },
        "sequence": (_el: asn1.ASN1Element): void => { sequence = _decode_AVMPsequence(_el); },
        "certlist": (_el: asn1.ASN1Element): void => { certlist = _decode_CertAVL(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_AddAvlReq = function (value: AddAvlReq, elGetter: __utils.ASN1Encoder<AddAvlReq>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ((value.version !== undefined && value.version !== v1) /* TODO: Review this condition. */ ? _encode_AVMPversion(value.version, __utils.BER) : undefined),
            __utils._encodeGeneralizedTime(value.timeStamp, __utils.BER),
...
export const _decode_AddAvlOK = function (el: asn1.ASN1Element): AddAvlOK {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 1) {
        throw new asn1.ASN1ConstructionError("AddAvlOK contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "ok";
    let ok!: asn1.NULL;
...
export const _encode_AddAvlOK = function (value: AddAvlOK, elGetter: __utils.ASN1Encoder<AddAvlOK>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
export const _decode_AddAvlErr = function (el: asn1.ASN1Element): AddAvlErr {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 1) {
        throw new asn1.ASN1ConstructionError("AddAvlErr contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    ...
    // TODO: Validate values.
    return new AddAvlErr(
        notOK,
        sequence.slice(1),
    );
};
export const _encode_AddAvlErr = function (value: AddAvlErr, elGetter: __utils.ASN1Encoder<AddAvlErr>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
export type AddAvlRsp_result =
    ...
    | { failure: AddAvlErr }
    | asn1.ASN1Element;
export const _decode_AddAvlRsp_result = __utils._decode_extensible_choice<AddAvlRsp_result>({
    "CONTEXT 0": [ "success", __utils._decode_explicit<AddAvlOK>(() => _decode_AddAvlOK) ],
    "CONTEXT 1": [ "failure", __utils._decode_explicit<AddAvlErr>(() => _decode_AddAvlErr) ]
});
export const _encode_AddAvlRsp_result = __utils._encode_choice<AddAvlRsp_result>({
    "success": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_AddAvlOK, __utils.BER),
    "failure": __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_AddAvlErr, __utils.BER),
}, __utils.BER);
...
export const _decode_AddAvlRsp = function (el: asn1.ASN1Element): AddAvlRsp {
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "timeStamp": (_el: asn1.ASN1Element): void => { timeStamp = __utils._decodeGeneralizedTime(_el); },
        "sequence": (_el: asn1.ASN1Element): void => { sequence = _decode_AVMPsequence(_el); },
        "result": (_el: asn1.ASN1Element): void => { result = _decode_AddAvlRsp_result(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_AddAvlRsp = function (value: AddAvlRsp, elGetter: __utils.ASN1Encoder<AddAvlRsp>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ((value.version !== undefined && value.version !== v1) /* TODO: Review this condition. */ ? _encode_AVMPversion(value.version, __utils.BER) : undefined),
            __utils._encodeGeneralizedTime(value.timeStamp, __utils.BER),
...
export const _decode_ReplaceAvlReq = function (el: asn1.ASN1Element): ReplaceAvlReq {
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "timeStamp": (_el: asn1.ASN1Element): void => { timeStamp = __utils._decodeGeneralizedTime(_el); },
        "sequence": (_el: asn1.ASN1Element): void => { sequence = _decode_AVMPsequence(_el); },
        "old": (_el: asn1.ASN1Element): void => { old = _decode_AvlSerialNumber(_el); },
        "new": (_el: asn1.ASN1Element): void => { new_ = _decode_CertAVL(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_ReplaceAvlReq = function (value: ReplaceAvlReq, elGetter: __utils.ASN1Encoder<ReplaceAvlReq>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ((value.version !== undefined && value.version !== v1) /* TODO: Review this condition. */ ? _encode_AVMPversion(value.version, __utils.BER) : undefined),
            __utils._encodeGeneralizedTime(value.timeStamp, __utils.BER),
            _encode_AVMPsequence(value.sequence, __utils.BER),
            (value.old ? _encode_AvlSerialNumber(value.old, __utils.BER) : undefined),
...
export const _decode_RepAvlOK = function (el: asn1.ASN1Element): RepAvlOK {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 1) {
        throw new asn1.ASN1ConstructionError("RepAvlOK contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "ok";
    let ok!: asn1.NULL;
...
export const _encode_RepAvlOK = function (value: RepAvlOK, elGetter: __utils.ASN1Encoder<RepAvlOK>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            __utils._encodeNull(value.ok, __utils.BER)
        ],
...
export const _decode_RepAvlErr = function (el: asn1.ASN1Element): RepAvlErr {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 1) {
        throw new asn1.ASN1ConstructionError("RepAvlErr contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "notOK";
    let notOK!: AVMP_error;
    notOK = _decode_AVMP_error(sequence[0]);
    // TODO: Validate values.
    return new RepAvlErr(
        notOK,
        sequence.slice(1),
    );
};
export const _encode_RepAvlErr = function (value: RepAvlErr, elGetter: __utils.ASN1Encoder<RepAvlErr>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            _encode_AVMP_error(value.notOK, __utils.BER)
        ],
...
export type ReplaceAvlRsp_result =
    ...
    | { failure: RepAvlErr }
    | asn1.ASN1Element;
export const _decode_ReplaceAvlRsp_result = __utils._decode_extensible_choice<ReplaceAvlRsp_result>({
    "CONTEXT 0": [ "success", __utils._decode_explicit<RepAvlOK>(() => _decode_RepAvlOK) ],
    "CONTEXT 1": [ "failure", __utils._decode_explicit<RepAvlErr>(() => _decode_RepAvlErr) ]
});
export const _encode_ReplaceAvlRsp_result = __utils._encode_choice<ReplaceAvlRsp_result>({
    "success": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_RepAvlOK, __utils.BER),
    "failure": __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_RepAvlErr, __utils.BER),
}, __utils.BER);
...
export const _decode_ReplaceAvlRsp = function (el: asn1.ASN1Element): ReplaceAvlRsp {
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "timeStamp": (_el: asn1.ASN1Element): void => { timeStamp = __utils._decodeGeneralizedTime(_el); },
        "sequence": (_el: asn1.ASN1Element): void => { sequence = _decode_AVMPsequence(_el); },
        "result": (_el: asn1.ASN1Element): void => { result = _decode_ReplaceAvlRsp_result(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_ReplaceAvlRsp = function (value: ReplaceAvlRsp, elGetter: __utils.ASN1Encoder<ReplaceAvlRsp>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ((value.version !== undefined && value.version !== v1) /* TODO: Review this condition. */ ? _encode_AVMPversion(value.version, __utils.BER) : undefined),
            __utils._encodeGeneralizedTime(value.timeStamp, __utils.BER),
...
export const _decode_DeleteAvlReq = function (el: asn1.ASN1Element): DeleteAvlReq {
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "timeStamp": (_el: asn1.ASN1Element): void => { timeStamp = __utils._decodeGeneralizedTime(_el); },
        "sequence": (_el: asn1.ASN1Element): void => { sequence = _decode_AVMPsequence(_el); },
        "avl-Id": (_el: asn1.ASN1Element): void => { avl_Id = _decode_AvlSerialNumber(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_DeleteAvlReq = function (value: DeleteAvlReq, elGetter: __utils.ASN1Encoder<DeleteAvlReq>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ((value.version !== undefined && value.version !== v1) /* TODO: Review this condition. */ ? _encode_AVMPversion(value.version, __utils.BER) : undefined),
            __utils._encodeGeneralizedTime(value.timeStamp, __utils.BER),
            _encode_AVMPsequence(value.sequence, __utils.BER),
            (value.avl_Id ? _encode_AvlSerialNumber(value.avl_Id, __utils.BER) : undefined)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_DelAvlOK = function (el: asn1.ASN1Element): DelAvlOK {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 1) {
        throw new asn1.ASN1ConstructionError("DelAvlOK contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "ok";
    let ok!: asn1.NULL;
...
export const _encode_DelAvlOK = function (value: DelAvlOK, elGetter: __utils.ASN1Encoder<DelAvlOK>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            __utils._encodeNull(value.ok, __utils.BER)
        ],
...
export const _decode_DelAvlErr = function (el: asn1.ASN1Element): DelAvlErr {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 1) {
        throw new asn1.ASN1ConstructionError("DelAvlErr contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "notOK";
    let notOK!: AVMP_error;
    notOK = _decode_AVMP_error(sequence[0]);
    // TODO: Validate values.
    return new DelAvlErr(
        notOK,
        sequence.slice(1),
    );
};
export const _encode_DelAvlErr = function (value: DelAvlErr, elGetter: __utils.ASN1Encoder<DelAvlErr>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            _encode_AVMP_error(value.notOK, __utils.BER)
        ],
...
export type DeleteAvlRsp_result =
    ...
    | { failure: DelAvlErr }
    | asn1.ASN1Element;
export const _decode_DeleteAvlRsp_result = __utils._decode_extensible_choice<DeleteAvlRsp_result>({
    "CONTEXT 0": [ "success", __utils._decode_explicit<DelAvlOK>(() => _decode_DelAvlOK) ],
    "CONTEXT 1": [ "failure", __utils._decode_explicit<DelAvlErr>(() => _decode_DelAvlErr) ]
});
export const _encode_DeleteAvlRsp_result = __utils._encode_choice<DeleteAvlRsp_result>({
    "success": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_DelAvlOK, __utils.BER),
    "failure": __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_DelAvlErr, __utils.BER),
}, __utils.BER);
...
export const _decode_DeleteAvlRsp = function (el: asn1.ASN1Element): DeleteAvlRsp {
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "timeStamp": (_el: asn1.ASN1Element): void => { timeStamp = __utils._decodeGeneralizedTime(_el); },
        "sequence": (_el: asn1.ASN1Element): void => { sequence = _decode_AVMPsequence(_el); },
        "result": (_el: asn1.ASN1Element): void => { result = _decode_DeleteAvlRsp_result(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_DeleteAvlRsp = function (value: DeleteAvlRsp, elGetter: __utils.ASN1Encoder<DeleteAvlRsp>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ((value.version !== undefined && value.version !== v1) /* TODO: Review this condition. */ ? _encode_AVMPversion(value.version, __utils.BER) : undefined),
            __utils._encodeGeneralizedTime(value.timeStamp, __utils.BER),
...
export const _decode_RejectAVL = function (el: asn1.ASN1Element): RejectAVL {
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "timeStamp": (_el: asn1.ASN1Element): void => { timeStamp = __utils._decodeGeneralizedTime(_el); },
        "sequence": (_el: asn1.ASN1Element): void => { sequence = _decode_AVMPsequence(_el); },
        "reason": (_el: asn1.ASN1Element): void => { reason = _decode_AVMP_error(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_RejectAVL = function (value: RejectAVL, elGetter: __utils.ASN1Encoder<RejectAVL>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ((value.version !== undefined && value.version !== v1) /* TODO: Review this condition. */ ? _encode_AVMPversion(value.version, __utils.BER) : undefined),
            __utils._encodeGeneralizedTime(value.timeStamp, __utils.BER),
...
export const _decode_CASPcommonComponents = function (el: asn1.ASN1Element): CASPcommonComponents {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "version": (_el: asn1.ASN1Element): void => { version = _decode_CASPversion(_el); },
        "sequence": (_el: asn1.ASN1Element): void => { sequence = _decode_CASPsequence(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_CASPcommonComponents = function (value: CASPcommonComponents, elGetter: __utils.ASN1Encoder<CASPcommonComponents>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ((value.version !== undefined && value.version !== v1) /* TODO: Review this condition. */ ? _encode_CASPversion(value.version, __utils.BER) : undefined),
...
export const _decode_CertSubscribeReq_certs_Item = function (el: asn1.ASN1Element): CertSubscribeReq_certs_Item {
    ...
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("CertSubscribeReq-certs-Item contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
...
export const _encode_CertSubscribeReq_certs_Item = function (value: CertSubscribeReq_certs_Item, elGetter: __utils.ASN1Encoder<CertSubscribeReq_certs_Item>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
export const _decode_CertSubscribeReq = function (el: asn1.ASN1Element): CertSubscribeReq {
    ...
    const callbacks: __utils.DecodingMap = {
        "version": (_el: asn1.ASN1Element): void => { version = _decode_CASPversion(_el); },
        "sequence": (_el: asn1.ASN1Element): void => { sequence = _decode_CASPsequence(_el); },
        "certs": (_el: asn1.ASN1Element): void => { certs = __utils._decodeSequenceOf<CertSubscribeReq_certs_Item>(() => _decode_CertSubscribeReq_certs_Item)(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_CertSubscribeReq = function (value: CertSubscribeReq, elGetter: __utils.ASN1Encoder<CertSubscribeReq>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ((value.version !== undefined && value.version !== v1) /* TODO: Review this condition. */ ? _encode_CASPversion(value.version, __utils.BER) : undefined),
            _encode_CASPsequence(value.sequence, __utils.BER),
            __utils._encodeSequenceOf<CertSubscribeReq_certs_Item>(() => _encode_CertSubscribeReq_certs_Item, __utils.BER)(value.certs, __utils.BER)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_CertSubscribeOK_Item_ok = function (el: asn1.ASN1Element): CertSubscribeOK_Item_ok {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "cert": (_el: asn1.ASN1Element): void => { cert = _decode_Certificate(_el); },
        "status": (_el: asn1.ASN1Element): void => { status = _decode_CertStatus(_el); },
        "revokeReason": (_el: asn1.ASN1Element): void => { revokeReason = _decode_CRLReason(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_CertSubscribeOK_Item_ok = function (value: CertSubscribeOK_Item_ok, elGetter: __utils.ASN1Encoder<CertSubscribeOK_Item_ok>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            _encode_Certificate(value.cert, __utils.BER),
            _encode_CertStatus(value.status, __utils.BER),
            (value.revokeReason ? _encode_CRLReason(value.revokeReason, __utils.BER) : undefined)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_CertSubscribeOK_Item_not_ok = function (el: asn1.ASN1Element): CertSubscribeOK_Item_not_ok {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 1) {
        throw new asn1.ASN1ConstructionError("CertSubscribeOK-Item-not-ok contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
...
export const _encode_CertSubscribeOK_Item_not_ok = function (value: CertSubscribeOK_Item_not_ok, elGetter: __utils.ASN1Encoder<CertSubscribeOK_Item_not_ok>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
export type CertSubscribeOK_Item =
    ...
    | asn1.ASN1Element;
export const _decode_CertSubscribeOK_Item = __utils._decode_extensible_choice<CertSubscribeOK_Item>({
    "CONTEXT 0": [ "ok", __utils._decode_explicit<CertSubscribeOK_Item_ok>(() => _decode_CertSubscribeOK_Item_ok) ],
    "CONTEXT 1": [ "not_ok", __utils._decode_explicit<CertSubscribeOK_Item_not_ok>(() => _decode_CertSubscribeOK_Item_not_ok) ]
});
export const _encode_CertSubscribeOK_Item = __utils._encode_choice<CertSubscribeOK_Item>({
    "ok": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_CertSubscribeOK_Item_ok, __utils.BER),
    "not_ok": __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_CertSubscribeOK_Item_not_ok, __utils.BER),
}, __utils.BER);


export type CertSubscribeOK = CertSubscribeOK_Item[]; // SequenceOfType
export const _decode_CertSubscribeOK = __utils._decodeSequenceOf<CertSubscribeOK_Item>(() => _decode_CertSubscribeOK_Item);
export const _encode_CertSubscribeOK = __utils._encodeSequenceOf<CertSubscribeOK_Item>(() => _encode_CertSubscribeOK_Item, __utils.BER);
...
export const _decode_CertSubscribeErr = function (el: asn1.ASN1Element): CertSubscribeErr {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 1) {
        throw new asn1.ASN1ConstructionError("CertSubscribeErr contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    ...
    // TODO: Validate values.
    return new CertSubscribeErr(
        code,
        sequence.slice(1),
    );
};
export const _encode_CertSubscribeErr = function (value: CertSubscribeErr, elGetter: __utils.ASN1Encoder<CertSubscribeErr>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
export type CertSubscribeRsp_result =
    ...
    | asn1.ASN1Element;
export const _decode_CertSubscribeRsp_result = __utils._decode_extensible_choice<CertSubscribeRsp_result>({
    "CONTEXT 0": [ "success", __utils._decode_explicit<CertSubscribeOK>(() => _decode_CertSubscribeOK) ],
    "CONTEXT 1": [ "failure", __utils._decode_explicit<CertSubscribeErr>(() => _decode_CertSubscribeErr) ]
});
export const _encode_CertSubscribeRsp_result = __utils._encode_choice<CertSubscribeRsp_result>({
    "success": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_CertSubscribeOK, __utils.BER),
    "failure": __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_CertSubscribeErr, __utils.BER),
}, __utils.BER);
...
export const _decode_CertSubscribeRsp = function (el: asn1.ASN1Element): CertSubscribeRsp {
    ...
    const callbacks: __utils.DecodingMap = {
        "version": (_el: asn1.ASN1Element): void => { version = _decode_CASPversion(_el); },
        "sequence": (_el: asn1.ASN1Element): void => { sequence = _decode_CASPsequence(_el); },
        "result": (_el: asn1.ASN1Element): void => { result = _decode_CertSubscribeRsp_result(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_CertSubscribeRsp = function (value: CertSubscribeRsp, elGetter: __utils.ASN1Encoder<CertSubscribeRsp>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ((value.version !== undefined && value.version !== v1) /* TODO: Review this condition. */ ? _encode_CASPversion(value.version, __utils.BER) : undefined),
            _encode_CASPsequence(value.sequence, __utils.BER),
...
export const _decode_CertUnsubscribeReq_certs_Item = function (el: asn1.ASN1Element): CertUnsubscribeReq_certs_Item {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("CertUnsubscribeReq-certs-Item contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "subject";
    sequence[1].name = "serialNumber";
...
export const _encode_CertUnsubscribeReq_certs_Item = function (value: CertUnsubscribeReq_certs_Item, elGetter: __utils.ASN1Encoder<CertUnsubscribeReq_certs_Item>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            _encode_Name(value.subject, __utils.BER),
            _encode_CertificateSerialNumber(value.serialNumber, __utils.BER)
...
export const _decode_CertUnsubscribeReq = function (el: asn1.ASN1Element): CertUnsubscribeReq {
    ...
    const callbacks: __utils.DecodingMap = {
        "version": (_el: asn1.ASN1Element): void => { version = _decode_CASPversion(_el); },
        "sequence": (_el: asn1.ASN1Element): void => { sequence = _decode_CASPsequence(_el); },
        "certs": (_el: asn1.ASN1Element): void => { certs = __utils._decodeSequenceOf<CertUnsubscribeReq_certs_Item>(() => _decode_CertUnsubscribeReq_certs_Item)(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_CertUnsubscribeReq = function (value: CertUnsubscribeReq, elGetter: __utils.ASN1Encoder<CertUnsubscribeReq>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ((value.version !== undefined && value.version !== v1) /* TODO: Review this condition. */ ? _encode_CASPversion(value.version, __utils.BER) : undefined),
            _encode_CASPsequence(value.sequence, __utils.BER),
            __utils._encodeSequenceOf<CertUnsubscribeReq_certs_Item>(() => _encode_CertUnsubscribeReq_certs_Item, __utils.BER)(value.certs, __utils.BER)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_CertUnsubscribeOK_Item_ok = function (el: asn1.ASN1Element): CertUnsubscribeOK_Item_ok {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("CertUnsubscribeOK-Item-ok contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "subject";
    sequence[1].name = "serialNumber";
...
export const _encode_CertUnsubscribeOK_Item_ok = function (value: CertUnsubscribeOK_Item_ok, elGetter: __utils.ASN1Encoder<CertUnsubscribeOK_Item_ok>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            _encode_Name(value.subject, __utils.BER),
            _encode_CertificateSerialNumber(value.serialNumber, __utils.BER)
...
export const _decode_CertUnsubscribeOK_Item_not_ok = function (el: asn1.ASN1Element): CertUnsubscribeOK_Item_not_ok {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 1) {
        throw new asn1.ASN1ConstructionError("CertUnsubscribeOK-Item-not-ok contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "status";
    let status!: CASP_CertStatusCode;
...
export const _encode_CertUnsubscribeOK_Item_not_ok = function (value: CertUnsubscribeOK_Item_not_ok, elGetter: __utils.ASN1Encoder<CertUnsubscribeOK_Item_not_ok>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            _encode_CASP_CertStatusCode(value.status, __utils.BER)
        ],
...
export type CertUnsubscribeOK_Item =
    ...
    | asn1.ASN1Element;
export const _decode_CertUnsubscribeOK_Item = __utils._decode_extensible_choice<CertUnsubscribeOK_Item>({
    "CONTEXT 0": [ "ok", __utils._decode_explicit<CertUnsubscribeOK_Item_ok>(() => _decode_CertUnsubscribeOK_Item_ok) ],
    "CONTEXT 1": [ "not_ok", __utils._decode_explicit<CertUnsubscribeOK_Item_not_ok>(() => _decode_CertUnsubscribeOK_Item_not_ok) ]
});
export const _encode_CertUnsubscribeOK_Item = __utils._encode_choice<CertUnsubscribeOK_Item>({
    "ok": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_CertUnsubscribeOK_Item_ok, __utils.BER),
    "not_ok": __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_CertUnsubscribeOK_Item_not_ok, __utils.BER),
}, __utils.BER);


export type CertUnsubscribeOK = CertUnsubscribeOK_Item[]; // SequenceOfType
export const _decode_CertUnsubscribeOK = __utils._decodeSequenceOf<CertUnsubscribeOK_Item>(() => _decode_CertUnsubscribeOK_Item);
export const _encode_CertUnsubscribeOK = __utils._encodeSequenceOf<CertUnsubscribeOK_Item>(() => _encode_CertUnsubscribeOK_Item, __utils.BER);
...
export const _decode_CertUnsubscribeErr = function (el: asn1.ASN1Element): CertUnsubscribeErr {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 1) {
        throw new asn1.ASN1ConstructionError("CertUnsubscribeErr contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "code";
    let code!: CASP_error;
    code = _decode_CASP_error(sequence[0]);
    // TODO: Validate values.
    return new CertUnsubscribeErr(
        code,
        sequence.slice(1),
    );
};
export const _encode_CertUnsubscribeErr = function (value: CertUnsubscribeErr, elGetter: __utils.ASN1Encoder<CertUnsubscribeErr>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            _encode_CASP_error(value.code, __utils.BER)
        ],
...
export type CertUnsubscribeRsp_result =
    ...
    | asn1.ASN1Element;
export const _decode_CertUnsubscribeRsp_result = __utils._decode_extensible_choice<CertUnsubscribeRsp_result>({
    "CONTEXT 0": [ "success", __utils._decode_explicit<CertUnsubscribeOK>(() => _decode_CertUnsubscribeOK) ],
    "CONTEXT 1": [ "failure", __utils._decode_explicit<CertUnsubscribeErr>(() => _decode_CertUnsubscribeErr) ]
});
export const _encode_CertUnsubscribeRsp_result = __utils._encode_choice<CertUnsubscribeRsp_result>({
    "success": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_CertUnsubscribeOK, __utils.BER),
    "failure": __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_CertUnsubscribeErr, __utils.BER),
}, __utils.BER);
...
export const _decode_CertUnsubscribeRsp = function (el: asn1.ASN1Element): CertUnsubscribeRsp {
    ...
    const callbacks: __utils.DecodingMap = {
        "version": (_el: asn1.ASN1Element): void => { version = _decode_CASPversion(_el); },
        "sequence": (_el: asn1.ASN1Element): void => { sequence = _decode_CASPsequence(_el); },
        "result": (_el: asn1.ASN1Element): void => { result = _decode_CertUnsubscribeRsp_result(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_CertUnsubscribeRsp = function (value: CertUnsubscribeRsp, elGetter: __utils.ASN1Encoder<CertUnsubscribeRsp>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ((value.version !== undefined && value.version !== v1) /* TODO: Review this condition. */ ? _encode_CASPversion(value.version, __utils.BER) : undefined),
            _encode_CASPsequence(value.sequence, __utils.BER),
            _encode_CertUnsubscribeRsp_result(value.result, __utils.BER)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_CertReplaceReq_certs_Item = function (el: asn1.ASN1Element): CertReplaceReq_certs_Item {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("CertReplaceReq-certs-Item contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "old";
    sequence[1].name = "new";
...
export const _encode_CertReplaceReq_certs_Item = function (value: CertReplaceReq_certs_Item, elGetter: __utils.ASN1Encoder<CertReplaceReq_certs_Item>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
export const _decode_CertReplaceReq = function (el: asn1.ASN1Element): CertReplaceReq {
    ...
    const callbacks: __utils.DecodingMap = {
        "version": (_el: asn1.ASN1Element): void => { version = _decode_CASPversion(_el); },
        "sequence": (_el: asn1.ASN1Element): void => { sequence = _decode_CASPsequence(_el); },
        "certs": (_el: asn1.ASN1Element): void => { certs = __utils._decodeSequenceOf<CertReplaceReq_certs_Item>(() => _decode_CertReplaceReq_certs_Item)(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_CertReplaceReq = function (value: CertReplaceReq, elGetter: __utils.ASN1Encoder<CertReplaceReq>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ((value.version !== undefined && value.version !== v1) /* TODO: Review this condition. */ ? _encode_CASPversion(value.version, __utils.BER) : undefined),
            _encode_CASPsequence(value.sequence, __utils.BER),
            __utils._encodeSequenceOf<CertReplaceReq_certs_Item>(() => _encode_CertReplaceReq_certs_Item, __utils.BER)(value.certs, __utils.BER)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_CertReplaceOK_Item_ok = function (el: asn1.ASN1Element): CertReplaceOK_Item_ok {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("CertReplaceOK-Item-ok contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
...
export const _encode_CertReplaceOK_Item_ok = function (value: CertReplaceOK_Item_ok, elGetter: __utils.ASN1Encoder<CertReplaceOK_Item_ok>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
export const _decode_CertReplaceOK_Item_not_ok = function (el: asn1.ASN1Element): CertReplaceOK_Item_not_ok {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 1) {
        throw new asn1.ASN1ConstructionError("CertReplaceOK-Item-not-ok contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "status";
    let status!: CASP_CertStatusCode;
...
export const _encode_CertReplaceOK_Item_not_ok = function (value: CertReplaceOK_Item_not_ok, elGetter: __utils.ASN1Encoder<CertReplaceOK_Item_not_ok>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            _encode_CASP_CertStatusCode(value.status, __utils.BER)
        ],
...
export type CertReplaceOK_Item =
    ...
    | asn1.ASN1Element;
export const _decode_CertReplaceOK_Item = __utils._decode_extensible_choice<CertReplaceOK_Item>({
    "CONTEXT 0": [ "ok", __utils._decode_explicit<CertReplaceOK_Item_ok>(() => _decode_CertReplaceOK_Item_ok) ],
    "CONTEXT 1": [ "not_ok", __utils._decode_explicit<CertReplaceOK_Item_not_ok>(() => _decode_CertReplaceOK_Item_not_ok) ]
});
export const _encode_CertReplaceOK_Item = __utils._encode_choice<CertReplaceOK_Item>({
    "ok": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_CertReplaceOK_Item_ok, __utils.BER),
    "not_ok": __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_CertReplaceOK_Item_not_ok, __utils.BER),
}, __utils.BER);


export type CertReplaceOK = CertReplaceOK_Item[]; // SequenceOfType
export const _decode_CertReplaceOK = __utils._decodeSequenceOf<CertReplaceOK_Item>(() => _decode_CertReplaceOK_Item);
export const _encode_CertReplaceOK = __utils._encodeSequenceOf<CertReplaceOK_Item>(() => _encode_CertReplaceOK_Item, __utils.BER);
...
export type CertReplaceErr_code =
    ...
    | { casp: CASP_error }
    | asn1.ASN1Element;
export const _decode_CertReplaceErr_code = __utils._decode_extensible_choice<CertReplaceErr_code>({
    "CONTEXT 0": [ "signedData", __utils._decode_explicit<SignedData_error>(() => _decode_SignedData_error) ],
    "CONTEXT 1": [ "envelopedData", __utils._decode_explicit<EnvelopedData_error>(() => _decode_EnvelopedData_error) ],
    "CONTEXT 2": [ "casp", __utils._decode_explicit<CASP_error>(() => _decode_CASP_error) ]
});
export const _encode_CertReplaceErr_code = __utils._encode_choice<CertReplaceErr_code>({
    "signedData": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_SignedData_error, __utils.BER),
    "envelopedData": __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_EnvelopedData_error, __utils.BER),
    "casp": __utils._encode_explicit(asn1.ASN1TagClass.context, 2, () => _encode_CASP_error, __utils.BER),
}, __utils.BER);
...
export const _decode_CertReplaceErr = function (el: asn1.ASN1Element): CertReplaceErr {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 1) {
        throw new asn1.ASN1ConstructionError("CertReplaceErr contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "code";
    ...
    // TODO: Validate values.
    return new CertReplaceErr(
        code,
        sequence.slice(1),
    );
};
export const _encode_CertReplaceErr = function (value: CertReplaceErr, elGetter: __utils.ASN1Encoder<CertReplaceErr>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
export type CertReplaceRsp_result =
    ...
    | asn1.ASN1Element;
export const _decode_CertReplaceRsp_result = __utils._decode_extensible_choice<CertReplaceRsp_result>({
    "CONTEXT 0": [ "success", __utils._decode_explicit<CertReplaceOK>(() => _decode_CertReplaceOK) ],
    "CONTEXT 1": [ "failure", __utils._decode_explicit<CertReplaceErr>(() => _decode_CertReplaceErr) ]
});
export const _encode_CertReplaceRsp_result = __utils._encode_choice<CertReplaceRsp_result>({
    "success": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_CertReplaceOK, __utils.BER),
    "failure": __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_CertReplaceErr, __utils.BER),
}, __utils.BER);
...
export const _decode_CertReplaceRsp = function (el: asn1.ASN1Element): CertReplaceRsp {
    ...
    const callbacks: __utils.DecodingMap = {
        "version": (_el: asn1.ASN1Element): void => { version = _decode_CASPversion(_el); },
        "sequence": (_el: asn1.ASN1Element): void => { sequence = _decode_CASPsequence(_el); },
        "result": (_el: asn1.ASN1Element): void => { result = _decode_CertReplaceRsp_result(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_CertReplaceRsp = function (value: CertReplaceRsp, elGetter: __utils.ASN1Encoder<CertReplaceRsp>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ((value.version !== undefined && value.version !== v1) /* TODO: Review this condition. */ ? _encode_CASPversion(value.version, __utils.BER) : undefined),
            _encode_CASPsequence(value.sequence, __utils.BER),
...
export const _decode_CertUpdateReq_certs_Item = function (el: asn1.ASN1Element): CertUpdateReq_certs_Item {
    ...
    if (sequence.length < 3) {
        throw new asn1.ASN1ConstructionError("CertUpdateReq-certs-Item contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "subject";
    sequence[1].name = "serialNumber";
...
export const _encode_CertUpdateReq_certs_Item = function (value: CertUpdateReq_certs_Item, elGetter: __utils.ASN1Encoder<CertUpdateReq_certs_Item>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            _encode_Name(value.subject, __utils.BER),
            _encode_CertificateSerialNumber(value.serialNumber, __utils.BER),
...
export const _decode_CertUpdateReq = function (el: asn1.ASN1Element): CertUpdateReq {
    ...
    const callbacks: __utils.DecodingMap = {
        "version": (_el: asn1.ASN1Element): void => { version = _decode_CASPversion(_el); },
        "sequence": (_el: asn1.ASN1Element): void => { sequence = _decode_CASPsequence(_el); },
        "certs": (_el: asn1.ASN1Element): void => { certs = __utils._decodeSequenceOf<CertUpdateReq_certs_Item>(() => _decode_CertUpdateReq_certs_Item)(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_CertUpdateReq = function (value: CertUpdateReq, elGetter: __utils.ASN1Encoder<CertUpdateReq>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ((value.version !== undefined && value.version !== v1) /* TODO: Review this condition. */ ? _encode_CASPversion(value.version, __utils.BER) : undefined),
            _encode_CASPsequence(value.sequence, __utils.BER),
            __utils._encodeSequenceOf<CertUpdateReq_certs_Item>(() => _encode_CertUpdateReq_certs_Item, __utils.BER)(value.certs, __utils.BER)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_CertUpdateOK_Item_ok = function (el: asn1.ASN1Element): CertUpdateOK_Item_ok {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("CertUpdateOK-Item-ok contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "subject";
    sequence[1].name = "serialNumber";
...
export const _encode_CertUpdateOK_Item_ok = function (value: CertUpdateOK_Item_ok, elGetter: __utils.ASN1Encoder<CertUpdateOK_Item_ok>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            _encode_Name(value.subject, __utils.BER),
            _encode_CertificateSerialNumber(value.serialNumber, __utils.BER)
...
export const _decode_CertUpdateOK_Item_not_ok = function (el: asn1.ASN1Element): CertUpdateOK_Item_not_ok {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 1) {
        throw new asn1.ASN1ConstructionError("CertUpdateOK-Item-not-ok contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "status";
    let status!: CASP_CertStatusCode;
...
export const _encode_CertUpdateOK_Item_not_ok = function (value: CertUpdateOK_Item_not_ok, elGetter: __utils.ASN1Encoder<CertUpdateOK_Item_not_ok>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            _encode_CASP_CertStatusCode(value.status, __utils.BER)
        ],
...
export type CertUpdateOK_Item =
    ...
    | asn1.ASN1Element;
export const _decode_CertUpdateOK_Item = __utils._decode_extensible_choice<CertUpdateOK_Item>({
    "CONTEXT 0": [ "ok", __utils._decode_explicit<CertUpdateOK_Item_ok>(() => _decode_CertUpdateOK_Item_ok) ],
    "CONTEXT 1": [ "not_ok", __utils._decode_explicit<CertUpdateOK_Item_not_ok>(() => _decode_CertUpdateOK_Item_not_ok) ]
});
export const _encode_CertUpdateOK_Item = __utils._encode_choice<CertUpdateOK_Item>({
    "ok": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_CertUpdateOK_Item_ok, __utils.BER),
    "not_ok": __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_CertUpdateOK_Item_not_ok, __utils.BER),
}, __utils.BER);


export type CertUpdateOK = CertUpdateOK_Item[]; // SequenceOfType
export const _decode_CertUpdateOK = __utils._decodeSequenceOf<CertUpdateOK_Item>(() => _decode_CertUpdateOK_Item);
export const _encode_CertUpdateOK = __utils._encodeSequenceOf<CertUpdateOK_Item>(() => _encode_CertUpdateOK_Item, __utils.BER);
...
export const _decode_CertUpdateErr = function (el: asn1.ASN1Element): CertUpdateErr {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 1) {
        throw new asn1.ASN1ConstructionError("CertUpdateErr contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "code";
    let code!: CASP_error;
    code = _decode_CASP_error(sequence[0]);
    // TODO: Validate values.
    return new CertUpdateErr(
        code,
        sequence.slice(1),
    );
};
export const _encode_CertUpdateErr = function (value: CertUpdateErr, elGetter: __utils.ASN1Encoder<CertUpdateErr>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            _encode_CASP_error(value.code, __utils.BER)
        ],
...
export type CertUpdateRsp_result =
    ...
    | asn1.ASN1Element;
export const _decode_CertUpdateRsp_result = __utils._decode_extensible_choice<CertUpdateRsp_result>({
    "CONTEXT 0": [ "success", __utils._decode_explicit<CertUpdateOK>(() => _decode_CertUpdateOK) ],
    "CONTEXT 1": [ "failure", __utils._decode_explicit<CertUpdateErr>(() => _decode_CertUpdateErr) ]
});
export const _encode_CertUpdateRsp_result = __utils._encode_choice<CertUpdateRsp_result>({
    "success": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_CertUpdateOK, __utils.BER),
    "failure": __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_CertUpdateErr, __utils.BER),
}, __utils.BER);
...
export const _decode_CertUpdateRsp = function (el: asn1.ASN1Element): CertUpdateRsp {
    ...
    const callbacks: __utils.DecodingMap = {
        "version": (_el: asn1.ASN1Element): void => { version = _decode_CASPversion(_el); },
        "sequence": (_el: asn1.ASN1Element): void => { sequence = _decode_CASPsequence(_el); },
        "result": (_el: asn1.ASN1Element): void => { result = _decode_CertUpdateRsp_result(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_CertUpdateRsp = function (value: CertUpdateRsp, elGetter: __utils.ASN1Encoder<CertUpdateRsp>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ((value.version !== undefined && value.version !== v1) /* TODO: Review this condition. */ ? _encode_CASPversion(value.version, __utils.BER) : undefined),
            _encode_CASPsequence(value.sequence, __utils.BER),
...
export const _decode_RejectCAsubscribe = function (el: asn1.ASN1Element): RejectCAsubscribe {
    ...
    const callbacks: __utils.DecodingMap = {
        "version": (_el: asn1.ASN1Element): void => { version = _decode_CASPversion(_el); },
        "sequence": (_el: asn1.ASN1Element): void => { sequence = _decode_CASPsequence(_el); },
        "reason": (_el: asn1.ASN1Element): void => { reason = _decode_CASP_error(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_RejectCAsubscribe = function (value: RejectCAsubscribe, elGetter: __utils.ASN1Encoder<RejectCAsubscribe>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ((value.version !== undefined && value.version !== v1) /* TODO: Review this condition. */ ? _encode_CASPversion(value.version, __utils.BER) : undefined),
            _encode_CASPsequence(value.sequence, __utils.BER),
...
export const _decode_TBrequest = __utils._decode_extensible_choice<TBrequest>({
    "CONTEXT 0": [ "caCert", __utils._decode_explicit<PKCertIdentifier>(() => _decode_PKCertIdentifier) ],
    "CONTEXT 1": [ "subjectCert", __utils._decode_explicit<PKCertIdentifier>(() => _decode_PKCertIdentifier) ]
});
export const _encode_TBrequest = __utils._encode_choice<TBrequest>({
    "caCert": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_PKCertIdentifier, __utils.BER),
    "subjectCert": __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_PKCertIdentifier, __utils.BER),
}, __utils.BER);
...
export const _decode_TBOK = function (el: asn1.ASN1Element): TBOK {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "levelOfAssurance": (_el: asn1.ASN1Element): void => { levelOfAssurance = __utils._decode_explicit<asn1.INTEGER>(() => __utils._decodeInteger)(_el); },
        "confidenceLevel": (_el: asn1.ASN1Element): void => { confidenceLevel = __utils._decode_explicit<asn1.INTEGER>(() => __utils._decodeInteger)(_el); },
        "validationTime": (_el: asn1.ASN1Element): void => { validationTime = __utils._decode_explicit<asn1.UTCTime>(() => __utils._decodeUTCTime)(_el); },
        "info": (_el: asn1.ASN1Element): void => { info = __utils._decodeUTF8String(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_TBOK = function (value: TBOK, elGetter: __utils.ASN1Encoder<TBOK>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => __utils._encodeInteger, __utils.BER)(value.levelOfAssurance, __utils.BER),
            __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => __utils._encodeInteger, __utils.BER)(value.confidenceLevel, __utils.BER),
            __utils._encode_explicit(asn1.ASN1TagClass.context, 2, () => __utils._encodeUTCTime, __utils.BER)(value.validationTime, __utils.BER),
            (value.info ? __utils._encodeUTF8String(value.info, __utils.BER) : undefined)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_TBerror = function (el: asn1.ASN1Element): TBerror {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "code": (_el: asn1.ASN1Element): void => { code = _decode_TBerror_code(_el); },
        "diagnostic": (_el: asn1.ASN1Element): void => { diagnostic = __utils._decodeUTF8String(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_TBerror = function (value: TBerror, elGetter: __utils.ASN1Encoder<TBerror>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            _encode_TBerror_code(value.code, __utils.BER),
            (value.diagnostic ? __utils._encodeUTF8String(value.diagnostic, __utils.BER) : undefined)
        ],
        (value._unrecognizedExtensionsList ? value._unrecognizedExtensionsList : []),
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_TBresponse = __utils._decode_extensible_choice<TBresponse>({
    "CONTEXT 0": [ "success", __utils._decode_explicit<TBOK>(() => _decode_TBOK) ],
    "CONTEXT 1": [ "failure", __utils._decode_explicit<TBerror>(() => _decode_TBerror) ]
});
export const _encode_TBresponse = __utils._encode_choice<TBresponse>({
    "success": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_TBOK, __utils.BER),
    "failure": __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_TBerror, __utils.BER),
}, __utils.BER);
