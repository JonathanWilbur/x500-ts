...
export type Selection<T, K extends string> = T extends Record<K, any>
    ? T[K]
    : never;
...
export function hasTagNumberIn(tagNumbers: number[]): TagValidator {
    return function (index: number, elements: ASN1Element[]): boolean {
        return tagNumbers.some(
            (tn: number): boolean => tn === elements[index].tagNumber
        );
    };
}
...
export function _decode_explicit<T>(
    decoderGetter: () => (el: ASN1Element) => T
): ASN1Decoder<T> {
...
export function _decode_implicit<T>(
    decoderGetter: () => (el: ASN1Element) => T
): ASN1Decoder<T> {
    return (el: ASN1Element) => decoderGetter()(el);
}

export function _tagClass(
    class_: ASN1TagClass,
    encoderGetter: () => () => ASN1Element
): ASN1Element {
...
export function _construction(
    con: ASN1Construction,
    encoderGetter: () => () => ASN1Element
): ASN1Element {
    const el = encoderGetter()();
    el.construction = con;
...
export const BER: ASN1Encoder<any> = (
    value: any,
    elGetter: ASN1Encoder<any>
): ASN1Element => new BERElement();
export const CER: ASN1Encoder<any> = (
    value: any,
    elGetter: ASN1Encoder<any>
): ASN1Element => new CERElement();
export const DER: ASN1Encoder<any> = (
    value: any,
    elGetter: ASN1Encoder<any>
): ASN1Element => new DERElement();
...
export const _encodeUnrestrictedCharacterString: ASN1Encoder<CharacterString> = (
    ...
    elGetter: ASN1Encoder<CharacterString>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
...
export const _encodeEmbeddedPDV: ASN1Encoder<EMBEDDED_PDV> = (
    value: EMBEDDED_PDV,
    elGetter: ASN1Encoder<EMBEDDED_PDV>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
...
export const _encodeEnumerated: ASN1Encoder<ENUMERATED> = (
    value: ENUMERATED,
    elGetter: ASN1Encoder<ENUMERATED>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
    el.enumerated = value;
    el.tagClass = ASN1TagClass.universal;
...
export const _encodeInstanceOf: ASN1Encoder<INSTANCE_OF> = (
    value: INSTANCE_OF,
    elGetter: ASN1Encoder<INSTANCE_OF>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
    el.external = value;
    el.tagClass = ASN1TagClass.universal;
...
export const _encodeObjectIdentifier: ASN1Encoder<OBJECT_IDENTIFIER> = (
    ...
    elGetter: ASN1Encoder<OBJECT_IDENTIFIER>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
...
export const _encodeRelativeIRI: ASN1Encoder<RELATIVE_OID_IRI> = (
    value: RELATIVE_OID_IRI,
    elGetter: ASN1Encoder<RELATIVE_OID_IRI>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
...
export const _encodeRelativeOID: ASN1Encoder<RELATIVE_OID> = (
    value: RELATIVE_OID,
    elGetter: ASN1Encoder<RELATIVE_OID>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
...
export const _encodeSequence: ASN1Encoder<SEQUENCE<ASN1Element>> = (
    value: SEQUENCE<ASN1Element>,
    elGetter: ASN1Encoder<SEQUENCE<ASN1Element>>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
    el.sequence = value;
    el.tagClass = ASN1TagClass.universal;
...
export const _encodeSet: ASN1Encoder<SET<ASN1Element>> = (
    value: SET<ASN1Element>,
    elGetter: ASN1Encoder<SET<ASN1Element>>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
    el.set = value;
    el.tagClass = ASN1TagClass.universal;
...
export const _encodeTimeOfDay: ASN1Encoder<TIME_OF_DAY> = (
    value: TIME_OF_DAY,
    elGetter: ASN1Encoder<TIME_OF_DAY>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
    el.timeOfDay = value;
    el.tagClass = ASN1TagClass.universal;
...
export const _encodeBMPString: ASN1Encoder<BMPString> = (
    value: BMPString,
    elGetter: ASN1Encoder<BMPString>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
    el.bmpString = value;
    el.tagClass = ASN1TagClass.universal;
...
export const _encodeGeneralString: ASN1Encoder<GeneralString> = (
    value: GeneralString,
    elGetter: ASN1Encoder<GeneralString>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
...
export const _encodeGraphicString: ASN1Encoder<GraphicString> = (
    value: GraphicString,
    elGetter: ASN1Encoder<GraphicString>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
...
export const _encodeIA5String: ASN1Encoder<IA5String> = (
    value: IA5String,
    elGetter: ASN1Encoder<IA5String>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
    el.ia5String = value;
    el.tagClass = ASN1TagClass.universal;
...
export const _encodeISO646String: ASN1Encoder<ISO646String> = (
    value: ISO646String,
    elGetter: ASN1Encoder<ISO646String>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
    el.ia5String = value;
    el.tagClass = ASN1TagClass.universal;
...
export const _encodeNumericString: ASN1Encoder<NumericString> = (
    value: NumericString,
    elGetter: ASN1Encoder<NumericString>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
...
export const _encodePrintableString: ASN1Encoder<PrintableString> = (
    ...
    elGetter: ASN1Encoder<PrintableString>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
...
export const _encodeTeletexString: ASN1Encoder<TeletexString> = (
    value: TeletexString,
    elGetter: ASN1Encoder<TeletexString>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
...
export const _encodeT61String: ASN1Encoder<T61String> = (
    value: T61String,
    elGetter: ASN1Encoder<T61String>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
    el.teletexString = value;
    el.tagClass = ASN1TagClass.universal;
...
export const _encodeUniversalString: ASN1Encoder<UniversalString> = (
    ...
    elGetter: ASN1Encoder<UniversalString>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
...
export const _encodeUTF8String: ASN1Encoder<UTF8String> = (
    value: UTF8String,
    elGetter: ASN1Encoder<UTF8String>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
    el.utf8String = value;
    el.tagClass = ASN1TagClass.universal;
...
export const _encodeVideotexString: ASN1Encoder<VideotexString> = (
    ...
    elGetter: ASN1Encoder<VideotexString>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
...
export const _encodeVisibleString: ASN1Encoder<VisibleString> = (
    value: VisibleString,
    elGetter: ASN1Encoder<VisibleString>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
...
export const _encodeGeneralizedTime: ASN1Encoder<GeneralizedTime> = (
    ...
    elGetter: ASN1Encoder<GeneralizedTime>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
...
export const _encodeObjectDescriptor: ASN1Encoder<ObjectDescriptor> = (
    ...
    elGetter: ASN1Encoder<ObjectDescriptor>
) => {
    const el: ASN1Element = elGetter(value, elGetter);
...
export const _decodeDateTime: ASN1Decoder<DATE_TIME> = (
    el: ASN1Element
): DATE_TIME => {
    return el.dateTime;
};

export const _decodeDuration: ASN1Decoder<DURATION> = (
    el: ASN1Element
): DURATION => {
    return el.duration;
};

export const _decodeEmbeddedPDV: ASN1Decoder<EMBEDDED_PDV> = (
    el: ASN1Element
): EMBEDDED_PDV => {
    return el.embeddedPDV;
};

export const _decodeEnumerated: ASN1Decoder<ENUMERATED> = (
    el: ASN1Element
): ENUMERATED => {
    return el.enumerated;
};

export const _decodeExternal: ASN1Decoder<EXTERNAL> = (
    el: ASN1Element
): EXTERNAL => {
    return el.external;
};

export const _decodeInstanceOf: ASN1Decoder<INSTANCE_OF> = (
    el: ASN1Element
): INSTANCE_OF => {
    return el.external;
};

export const _decodeInteger: ASN1Decoder<INTEGER> = (
    el: ASN1Element
): INTEGER => {
    return el.integer;
};
...
export const _decodeObjectIdentifier: ASN1Decoder<OBJECT_IDENTIFIER> = (
    el: ASN1Element
): OBJECT_IDENTIFIER => {
    return el.objectIdentifier;
};

export const _decodeOctetString: ASN1Decoder<OCTET_STRING> = (
    el: ASN1Element
): OCTET_STRING => {
...
export const _decodeRelativeIRI: ASN1Decoder<RELATIVE_OID_IRI> = (
    el: ASN1Element
): RELATIVE_OID_IRI => {
    return el.relativeOIDIRI;
};

export const _decodeRelativeOID: ASN1Decoder<RELATIVE_OID> = (
    el: ASN1Element
): RELATIVE_OID => {
    return el.relativeObjectIdentifier;
};

export const _decodeSequence: ASN1Decoder<SEQUENCE<ASN1Element>> = (
    el: ASN1Element
): SEQUENCE<ASN1Element> => {
    return el.sequence;
};

export const _decodeSet: ASN1Decoder<SET<ASN1Element>> = (
    el: ASN1Element
): SET<ASN1Element> => {
    return el.set;
};
...
export const _decodeTimeOfDay: ASN1Decoder<TIME_OF_DAY> = (
    el: ASN1Element
): TIME_OF_DAY => {
    return el.timeOfDay;
};
...
export const _decodeBMPString: ASN1Decoder<BMPString> = (
    el: ASN1Element
): BMPString => {
    return el.bmpString;
};

export const _decodeGeneralString: ASN1Decoder<GeneralString> = (
    el: ASN1Element
): GeneralString => {
    return el.generalString;
};

export const _decodeGraphicString: ASN1Decoder<GraphicString> = (
    el: ASN1Element
): GraphicString => {
...
export const _decodeISO646String: ASN1Decoder<IA5String> = (
    el: ASN1Element
): IA5String => {
    return el.ia5String;
};
...
export function _parse_set(
    ...
    const rootComponents: ComponentSpec[] = rootComponentTypeList1.concat(
        rootComponentTypeList2
    );
    const components: ComponentSpec[] = rootComponents.concat(
        rootComponentTypeList2
    );
     ...
     */
    {
        const calculatedMaximumElements: number =
...

    {
        ...
        elements.forEach((e) => {
            ...
            if (encounteredTags.has(tag)) {
                throw new Error(
                    `Duplicate tag '${tagClassName(e.tagClass)} ${
                        e.tagNumber
                    }' in SET '${set.name}'.`
                );
            }
    ...
    elements.forEach((e, i) => {
        const spec: ComponentSpec | undefined = components.find((cs) =>
            cs.selector(i, elements)
        ); // 758eb9f0-2d70-4cbf-ad19-593bfb939113
        if (!spec) {
        ...
        if (encounteredComponents.has(spec.name)) {
            throw new Error(
                `SET '${set.name}' contained more than one '${spec.name}' component.`
            );
        }
    ...
    if (missingRequiredComponents.length > 0) {
        throw new Error(
            `SET '${
                set.name
            }' missing these required components: ${missingRequiredComponents.join(
                ", "
            )}.`
        );
    }
...
export function _parse_component_type_list(
    ...
    while (s < componentTypeList.length) {
        ...
        if (!element) {
            // If you have ran out of elements in the list.
            if (spec.optional) {
                // ... and its optional, just keep going.
                s++;
                continue;
                /**
                ...
                // The element was required as a part of an ExtensionAdditionsGroup.
                if (
                    spec.groupIndex !== undefined &&
                    spec.groupIndex <= (currentGroup || Infinity)
                ) {
                    throw new ASN1ConstructionError(
                        `Missing required extension '${spec.name}' in SEQUENCE.`
                    );
                } else {
                    s++;
                    continue;
                ...
                throw new ASN1ConstructionError(
                    `Missing required component '${spec.name}' in SEQUENCE.`
                );
            }
        }
 ...
 */
export function _parse_sequence_with_trailing_rctl(
    seq: ASN1Element,
    decodingCallbacks: DecodingMap,
    rootComponentTypeList1: ComponentSpec[],
    extensionAdditionsList: ComponentSpec[],
    ...
    const possibleInitialRCTL2Components: ComponentSpec[] = _get_possible_initial_components(
        rootComponentTypeList2
    );
    const rctl2EntirelyOptional: boolean = rootComponentTypeList2.every(
        (ct) => ct.optional
    );
    const extensionsOnwards: ASN1Element[] = elements.slice(startOfExtensions);
    let numberOfExtensionElements: number = extensionsOnwards.findIndex(
        (e, i): boolean =>
            possibleInitialRCTL2Components.some((pirctl2c): boolean =>
                pirctl2c.selector(i, extensionsOnwards)
            )
    );
    if (startOfExtensions === -1) {
        // We did not find RCTL2.
        if (rctl2EntirelyOptional) {
            numberOfExtensionElements = elements.length - startOfExtensions;
        } else {
            throw new Error(
                `Trailing root component type list for SEQUENCE '${seq.name}' not found.`
            );
        }
    }
    ...
    const endOfRecognizedExtensions: number =
        startOfExtensions + numberOfExtensionsRead;
    elements
    ...
    if (startOfRCTL2 + numberOfRCTL2ElementsRead !== elements.length) {
        throw new Error(
            `SEQUENCE '${seq.name}' had excess elements at the end.`
        );
    }
}

export function _parse_sequence_without_trailing_rctl(
    seq: ASN1Element,
    decodingCallbacks: DecodingMap,
    rootComponentTypeList1: ComponentSpec[],
    extensionAdditionsList: ComponentSpec[],
 ...
 * @param specification
 */
export function _parse_sequence(
    seq: ASN1Element,
    decodingCallbacks: DecodingMap,
    rootComponentTypeList1: ComponentSpec[],
    extensionAdditionsList: ComponentSpec[],
...
export function _encode_choice<T>(
    ...
    return function (value: T): ASN1Element {
        ...
        const key: keyof T | undefined = (Object.keys(value) as (
            | keyof T
            | undefined
        )[])[0];
        if (!key) {
...
export function _decodeSequenceOf<T>(
    decoderGetter: () => ASN1Decoder<T>
): SequenceOfDecoder<T> {
...
export function _decodeSetOf<T>(
    decoderGetter: () => (el: ASN1Element) => T
): SetOfDecoder<T> {
